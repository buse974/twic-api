...
class Course extends AbstractMapper
{
     ...
     */
    public function get($id, $user_id, $is_admin_academic, $is_student)
    {
        $select = $this->tableGateway->getSql()->select();
        
        $select->columns(array('id','title','abstract','description','picture','objectives','teaching','attendance','duration','video_link','video_token','learning_outcomes','notes', 'is_published'))
    ...
    public function getByItem($item_id)
    {
        $select = $this->tableGateway->getSql()->select();
        $select->columns(
            ['id','title','abstract','description','picture','objectives','teaching',
