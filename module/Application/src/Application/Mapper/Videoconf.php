...
class Videoconf extends AbstractMapper
{
    ...
    public function getBySubmission($submission)
    {
        ...
        $select->columns(array(
            ...
            'videoconf.submission_id' => $submission
        ));
    ...
    public function getByVideoconfArchive($video_archive)
    {
        ...
        $select->columns(array(
            ...
            ->where(array(
            'video_archive.id' => $video_archive
        ));
    ...
    public function getRoom($token)
    {
        ...
        $select->columns(array(
            ...
            ->join(array(
            'videoconf_videoconf_entity' => 'videoconf_entity'
        ), 'videoconf_videoconf_entity.videoconf_id=videoconf.id', array(
            'id',
            'name',
            'token'
        ))
            ->where(array(
            'videoconf_videoconf_entity.token' => $token
        ))
            ->where(array(
    ...
    public function getListVideoUpload()
    {
        ...
        $select->columns(array(
            ...
            'archive_status' => CVF::ARV_STARTED
        ));
