...
class MessageUser extends AbstractMapper
{
    ...
    public function getList($user_id, $message_id = null, $conversation_id = null, $tag = 'INBOX', $type = null, $filter = null, $search = null)
    {
        ...
        $select->columns(['id', 'user_id', 'from_id', 'read_date', 'message_id', 'conversation_id', 'message_user$created_date' => new Expression('DATE_FORMAT(message_user.created_date, "%Y-%m-%dT%TZ")')])
