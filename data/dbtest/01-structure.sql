...
-- jeu. 31 mars 2016 15:49:22 CEST
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `type` ENUM('LC','WG','CP','IA','DOC','TXT','POLL','MOD') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `questionnaire_user` (
  ...
  `item_prog_user_id` INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `submission_document` (
  ...
  `updated_date` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_item_assigment_document_1_idx` (`submission_id` ASC),
  CONSTRAINT `fk_item_assigment_document_1`
...
CREATE TABLE IF NOT EXISTS `assignment` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_assignment_1_idx` (`item_id` ASC),
...
CREATE TABLE IF NOT EXISTS `poll_question` (
  ...
  `poll_question_type_id` INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `poll_answer_items` (
  ...
  `poll_question_item_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  `answer` TEXT NULL DEFAULT NULL,
  `date` DATE NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `videoconf` (
  ...
  `item_prog_id` INT(10) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `submission_user` (
  ...
  INDEX `fk_submission_user_3_idx` (`group_id` ASC),
  ...
  CONSTRAINT `fk_submission_user_2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_submission_user_3`
    FOREIGN KEY (`group_id`)
    REFERENCES `group` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `opt_grading` (
  `item_id` INT UNSIGNED NOT NULL,
  `mode` ENUM('instructor', 'average', 'none') NOT NULL DEFAULT 'none',
...
CREATE TABLE IF NOT EXISTS `bank_question_item` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `libelle` VARCHAR(256) NULL DEFAULT NULL,
  `bank_question_id` INT(10) UNSIGNED NOT NULL,
  `parent_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_poll_question_item_10_idx` (`parent_id` ASC),
  INDEX `fk_bank_question_item_2_idx` (`bank_question_id` ASC),
...
-- -----------------------------------------------------
-- Table `bank_answer_items`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bank_answer_items` ;

CREATE TABLE IF NOT EXISTS `bank_answer_items` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
