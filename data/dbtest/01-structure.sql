...
-- lun. 25 avril 2016 11:42:33 CEST
...
-- -----------------------------------------------------
-- Table `sub_question_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sub_question_type` ;

CREATE TABLE IF NOT EXISTS `sub_question_type` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `sub_question` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_poll_question_1_idx` (`bank_question_type_id` ASC),
  CONSTRAINT `fk_poll_question_100`
    FOREIGN KEY (`bank_question_type_id`)
    REFERENCES `sub_question_type` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `poll_answer` (
  ...
  INDEX `fk_poll_answer_4_idx` (`sub_question_id` ASC),
  ...
  CONSTRAINT `fk_poll_answer_3`
    ...
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_poll_answer_4`
    FOREIGN KEY (`sub_question_id`)
    REFERENCES `sub_question` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_poll_answer_5`
    FOREIGN KEY (`group_question_id`)
    REFERENCES `group_question` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `sub_question_item`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sub_question_item` ;

CREATE TABLE IF NOT EXISTS `sub_question_item` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_bank_question_item_10`
    FOREIGN KEY (`bank_question_id`)
    REFERENCES `sub_question` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_bank_question_item_20`
    FOREIGN KEY (`order_id`)
    REFERENCES `sub_question_item` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `poll_answer_item`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `poll_answer_item` ;

CREATE TABLE IF NOT EXISTS `poll_answer_item` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `poll_answer_id` INT(10) UNSIGNED NOT NULL,
  `sub_question_item_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  `answer` TEXT NULL DEFAULT NULL,
  `date` DATE NULL DEFAULT NULL,
  `time` TIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_poll_answer_items_1_idx` (`poll_answer_id` ASC),
  INDEX `fk_poll_answer_item_1_idx` (`sub_question_item_id` ASC),
  CONSTRAINT `fk_poll_answer_item_2`
    FOREIGN KEY (`poll_answer_id`)
    REFERENCES `poll_answer` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_poll_answer_item_1`
    FOREIGN KEY (`sub_question_item_id`)
    REFERENCES `sub_question_item` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `sub_answer_item`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sub_answer_item` ;

CREATE TABLE IF NOT EXISTS `sub_answer_item` (
  `bank_question_item_id` INT(10) UNSIGNED NOT NULL,
  `percent` INT NULL,
  `answer` TEXT NULL DEFAULT NULL,
  `date` DATE NULL DEFAULT NULL,
  `time` TIME NULL DEFAULT NULL,
  INDEX `fk_poll_answer_items_20_idx` (`bank_question_item_id` ASC),
  CONSTRAINT `fk_poll_answer_items_200`
    FOREIGN KEY (`bank_question_item_id`)
    REFERENCES `sub_question_item` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `sub_question_tag`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sub_question_tag` ;

CREATE TABLE IF NOT EXISTS `sub_question_tag` (
  `bank_question_id` INT UNSIGNED NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  INDEX `fk_bank_question_tag_1_idx` (`bank_question_id` ASC),
  PRIMARY KEY (`bank_question_id`, `name`),
  UNIQUE INDEX `uq_tagbank` (`bank_question_id` ASC, `name` ASC),
  CONSTRAINT `fk_bank_question_tag_10`
    FOREIGN KEY (`bank_question_id`)
    REFERENCES `sub_question` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `sub_question_media`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sub_question_media` ;

CREATE TABLE IF NOT EXISTS `sub_question_media` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `bank_question_id` INT UNSIGNED NOT NULL,
  `token` VARCHAR(80) NULL,
  `link` TEXT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_bank_question_media_10`
    FOREIGN KEY (`bank_question_id`)
    REFERENCES `sub_question` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
