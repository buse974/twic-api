...
-- mar. 05 avril 2016 16:38:20 CEST
...
CREATE TABLE IF NOT EXISTS `conversation` (
  ...
  `created_date` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_conversation_1_idx` (`item_id` ASC),
...
CREATE TABLE IF NOT EXISTS `poll_answer` (
  ...
  INDEX `fk_poll_answer_4_idx` (`bank_question_id` ASC),
...
CREATE TABLE IF NOT EXISTS `bank_question_item` (
  ...
  `order_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_poll_question_item_10_idx` (`order_id` ASC),
...
CREATE TABLE IF NOT EXISTS `poll_answer_item` (
  ...
  INDEX `fk_poll_answer_item_1_idx` (`bank_question_item_id` ASC),
...
-- Table `opt_videoconf`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `opt_videoconf` ;

CREATE TABLE IF NOT EXISTS `opt_videoconf` (
  `item_id` INT UNSIGNED NOT NULL,
