...
-- lun. 08 juin 2015 15:47:06 CEST
...
CREATE TABLE IF NOT EXISTS `groupwork` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `groupwork` TEXT NULL,
  `groupwork_duration` INT NULL,
  `item_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_groupwork_1_idx` (`item_id` ASC),
  CONSTRAINT `fk_groupwork_1`
    FOREIGN KEY (`item_id`)
    REFERENCES `item` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `individual_assignment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `individual_assignment` ;

CREATE TABLE IF NOT EXISTS `individual_assignment` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `question` TEXT NULL,
  `item_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_individual_assignment_1_idx` (`item_id` ASC),
  CONSTRAINT `fk_individual_assignment_10`
    FOREIGN KEY (`item_id`)
    REFERENCES `item` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `individual_assignment_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `individual_assignment_user` ;

CREATE TABLE IF NOT EXISTS `individual_assignment_user` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `question` TEXT NULL,
  `individual_assigment_id` INT UNSIGNED NOT NULL,
  `user_id` INT UNSIGNED NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_individual_assignment_1_idx` (`individual_assigment_id` ASC),
  INDEX `fk_individual_assignment_user_2_idx` (`user_id` ASC),
  CONSTRAINT `fk_individual_assignment_user_1`
    FOREIGN KEY (`individual_assigment_id`)
    REFERENCES `individual_assignment` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_individual_assignment_user_2`
    FOREIGN KEY (`user_id`)
    REFERENCES `user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `live_class` (
  ...
  `item_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_live_class_1_idx` (`item_id` ASC),
  CONSTRAINT `fk_live_class_1`
    FOREIGN KEY (`item_id`)
    REFERENCES `item` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `item_prog_user_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `item_prog_user_relation` ;

CREATE TABLE IF NOT EXISTS `item_prog_user_relation` (
  `user_id` INT UNSIGNED NOT NULL,
  `item_prog_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`user_id`, `item_prog_id`),
...
CREATE TABLE IF NOT EXISTS `item_grading` (
  ...
  `created_date` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_item_grading_1_idx` (`item_id` ASC),
  INDEX `fk_item_grading_2_idx` (`user_id` ASC),
  INDEX `fk_item_grading_3_idx` (`grading_policy_id` ASC),
  CONSTRAINT `fk_item_grading_1`
    FOREIGN KEY (`item_id`)
    REFERENCES `item` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `item_grading_comment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `item_grading_comment` ;

CREATE TABLE IF NOT EXISTS `item_grading_comment` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `item_grading_id` INT UNSIGNED NULL,
  `comment` TEXT NULL,
  `created_date` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_item_grading_comment_1_idx` (`item_grading_id` ASC),
  CONSTRAINT `fk_item_grading_comment_1`
    FOREIGN KEY (`item_grading_id`)
    REFERENCES `item_grading` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `individual_assigment_document`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `individual_assigment_document` ;

CREATE TABLE IF NOT EXISTS `individual_assigment_document` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `individual_assigment_id` INT UNSIGNED NOT NULL,
  `type` VARCHAR(100) NULL,
  `title` VARCHAR(45) NULL,
  ...
  `updated_date` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_individual_assigment_document_1_idx` (`individual_assigment_id` ASC),
...
-- -----------------------------------------------------
-- Table `individual_assigment_document_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `individual_assigment_document_user` ;

CREATE TABLE IF NOT EXISTS `individual_assigment_document_user` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `individual_assigment_user_id` INT UNSIGNED NOT NULL,
  `type` VARCHAR(100) NULL,
  `title` VARCHAR(45) NULL,
  `author` VARCHAR(45) NULL,
  `link` VARCHAR(45) NULL,
  ...
  `updated_date` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_individual_assigment_document_user_1_idx` (`individual_assigment_user_id` ASC),
  CONSTRAINT `fk_individual_assigment_document_user_1`
    FOREIGN KEY (`individual_assigment_user_id`)
    REFERENCES `individual_assignment_user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
