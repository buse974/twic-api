...
-- mar. 26 avril 2016 15:44:58 CEST
...
CREATE TABLE IF NOT EXISTS `sub_quiz` (
  ...
  `submission_id` INT UNSIGNED NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_poll_answer_1_idx` (`start` ASC),
...
CREATE TABLE IF NOT EXISTS `sub_answer` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `sub_quiz_id` INT(10) UNSIGNED NOT NULL,
  `bank_question_item_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  `answer` TEXT NULL DEFAULT NULL,
  `date` DATE NULL DEFAULT NULL,
  `time` TIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_poll_answer_items_1_idx` (`sub_quiz_id` ASC),
