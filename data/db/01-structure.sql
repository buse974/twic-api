...
-- lun. 25 avril 2016 15:54:05 CEST
...
-- Table `sub_poll_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sub_poll_user` ;

CREATE TABLE IF NOT EXISTS `sub_poll_user` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `sub_poll_user_answer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sub_poll_user_answer` ;

CREATE TABLE IF NOT EXISTS `sub_poll_user_answer` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `sub_poll_user_id` INT(10) UNSIGNED NOT NULL,
  ...
  `created_date` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_poll_answer_items_1_idx` (`sub_poll_user_id` ASC),
  CONSTRAINT `fk_poll_answer_item_2`
    FOREIGN KEY (`sub_poll_user_id`)
    REFERENCES `sub_poll_user` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
