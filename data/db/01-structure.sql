...
-- lun. 06 juil. 2015 10:42:51 CEST
...
-- -----------------------------------------------------
-- Table `item_assignment_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `item_assignment_user` ;

CREATE TABLE IF NOT EXISTS `item_assignment_user` (
  `item_assignment_id` INT UNSIGNED NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`item_assignment_id`, `user_id`),
  INDEX `fk_item_assignment_user_2_idx` (`user_id` ASC),
