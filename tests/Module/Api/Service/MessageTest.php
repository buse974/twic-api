...
class MessageTest extends AbstractService
{
    ...
    public function testCanGetList($conv)
    {
        ...
        $this->assertEquals($data['result']['list'][1]['message']['from'][0]['id'] , 2);
        $this->assertEquals($data['result']['list'][1]['message']['from'][0]['firstname'] , "Xuan-Anh");
        $this->assertEquals($data['result']['list'][1]['message']['from'][0]['lastname'] , "Hoang");
        $this->assertEquals($data['result']['list'][1]['message']['from'][0]['email'] , "xhoang@thestudnet.com");
        ...
        $this->assertEquals($data['result']['list'][1]['message']['id'] , 2);
        $this->assertEquals($data['result']['list'][1]['message']['title'] , null);
        $this->assertEquals($data['result']['list'][1]['message']['text'] , "super message deux qwerty 1");
        ...
        $this->assertEquals($data['result']['list'][1]['id'] , 4);
