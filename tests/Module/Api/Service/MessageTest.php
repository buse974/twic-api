...
class MessageTest extends AbstractService
{
    ...
    public function testCanGetList($conv)
    {
        ...
        $this->assertEquals(count($data['result']['list'][1]['library']) , 6);
        $this->assertEquals($data['result']['list'][1]['library']['id'] , null);
        $this->assertEquals($data['result']['list'][1]['library']['name'] , null);
        $this->assertEquals($data['result']['list'][1]['library']['link'] , null);
        $this->assertEquals($data['result']['list'][1]['library']['token'] , null);
        $this->assertEquals($data['result']['list'][1]['library']['type'] , null);
        $this->assertEquals($data['result']['list'][1]['library']['box_id'] , null);
