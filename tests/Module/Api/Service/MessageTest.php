...
class MessageTest extends AbstractService
{
    ...
    public function testCanGetList($conv)
    {
        ...
        $this->assertEquals(count($data['result']['list'][1]['message']) , 6);
        ...
        $this->assertEquals(count($data['result']['list'][2]['message']) , 6);
    ...
    public function testCanAddSendMail()
    {
        ...
        $data = $this->jsonRpc('message.sendMail', array('document' => array('token1', 'token2'), 'title' => 'objet mail','to' => array(4,5),'text' => 'super message qwerty','draft' => true));
        ...
        $this->assertEquals($data['result']['message']['document'][0]['name'] , null);
        ...
        $this->assertEquals($data['result']['message']['document'][1]['name'] , null);
    ...
    public function testCanMessageGetListByTypeDraft()
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]) , 8);
        $this->assertEquals(count($data['result']['list'][0]['message']) , 7);
        ...
        $this->assertEquals($data['result']['list'][0]['message']['document'][0]['name'] , null);
        ...
        $this->assertEquals($data['result']['list'][0]['message']['document'][1]['name'] , null);
