...
class MessageTest extends AbstractService
{
    ...
    public function testCanSendMessage()
    {
        ...
        $this->assertEquals($data['result']['message']['from'][0]['roles'][0], "admin");
        ...
        $this->assertEquals(count($data['result']['message']['to'][1]['school']), 4);
    ...
    public function testCanGetList($conv)
    {
        ...
        $this->assertEquals(count($data['result']['list'][1]['message']['from'][0]['school']), 4);
        ...
        $this->assertEquals(count($data['result']['list'][1]['message']['to'][0]['school']), 4);
        ...
        $this->assertEquals($data['result']['list'][1]['message']['to'][0]['roles'][0], "super_admin");
        ...
        $this->assertEquals(count($data['result']['list'][2]['message']['from'][0]['school']), 4);
        ...
        $this->assertEquals($data['result']['list'][2]['message']['from'][0]['roles'][0], "super_admin");
        ...
        $this->assertEquals(count($data['result']['list'][2]['message']['to'][0]['school']), 4);
    ...
    public function testCanGetListConversation()
    {
        ...
        $this->assertEquals($data['result']['list'][1]['message']['from'][0]['avatar'], null);
        $this->assertEquals(count($data['result']['list'][1]['message']['from'][0]['roles']), 1);
        $this->assertEquals($data['result']['list'][1]['message']['from'][0]['roles'][0], "admin");
        $this->assertEquals(count($data['result']['list'][1]['message']['from'][0]['program']), 0);
        $this->assertEquals(count($data['result']['list'][1]['message']['document']), 0);
        ...
        $this->assertEquals(count($data['result']['list'][1]['message']['to'][1]['school']), 4);
        ...
        $this->assertEquals($data['result']['list'][1]['message']['to'][1]['roles'][0], "super_admin");
    ...
    public function testCanAddSendMail()
    {
        ...
        $this->assertEquals(count($data['result']), 8);
        $this->assertEquals(count($data['result']['message']), 10);
        $this->assertEquals(count($data['result']['message']['from']), 0);
        ...
        $this->assertEquals(count($data['result']['message']['to']), 3);
        $this->assertEquals(count($data['result']['message']['to'][0]), 13);
        $this->assertEquals($data['result']['message']['to'][0]['contact_state'], 0);
        $this->assertEquals(count($data['result']['message']['to'][0]['school']), 4);
        $this->assertEquals($data['result']['message']['to'][0]['school']['id'], 1);
        ...
        $this->assertEquals(count($data['result']['message']['to'][1]['program']), 0);
        $this->assertEquals(count($data['result']['message']['to'][2]), 13);
        $this->assertEquals($data['result']['message']['to'][2]['contact_state'], 0);
        $this->assertEquals(count($data['result']['message']['to'][2]['school']), 4);
        $this->assertEquals($data['result']['message']['to'][2]['school']['id'], 1);
        $this->assertEquals($data['result']['message']['to'][2]['school']['name'], "Morbi Corporation");
        $this->assertEquals($data['result']['message']['to'][2]['school']['short_name'], "turpis");
        $this->assertEquals($data['result']['message']['to'][2]['school']['logo'], null);
        $this->assertEquals($data['result']['message']['to'][2]['id'], 3);
        $this->assertEquals($data['result']['message']['to'][2]['firstname'], "Christophe");
        $this->assertEquals($data['result']['message']['to'][2]['lastname'], "Robert");
        $this->assertEquals($data['result']['message']['to'][2]['email'], "crobert@thestudnet.com");
        $this->assertEquals($data['result']['message']['to'][2]['password'], "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals($data['result']['message']['to'][2]['birth_date'], null);
        $this->assertEquals($data['result']['message']['to'][2]['position'], null);
        $this->assertEquals($data['result']['message']['to'][2]['interest'], null);
        $this->assertEquals($data['result']['message']['to'][2]['avatar'], null);
        $this->assertEquals(count($data['result']['message']['to'][2]['roles']), 1);
        $this->assertEquals($data['result']['message']['to'][2]['roles'][0], "academic");
        $this->assertEquals(count($data['result']['message']['to'][2]['program']), 0);
    ...
    public function testCanAddSendMailUpdate($message_id)
    {
        ...
        $this->assertEquals($data['result']['message']['to'][2]['school']['short_name'], "turpis");
        $this->assertEquals($data['result']['message']['to'][2]['school']['logo'], null);
        $this->assertEquals($data['result']['message']['to'][2]['id'], 1);
        $this->assertEquals($data['result']['message']['to'][2]['firstname'], "Paul");
        $this->assertEquals($data['result']['message']['to'][2]['lastname'], "Boussekey");
        $this->assertEquals($data['result']['message']['to'][2]['email'], "pboussekey@thestudnet.com");
        $this->assertEquals($data['result']['message']['to'][2]['password'], "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals($data['result']['message']['to'][2]['birth_date'], null);
        $this->assertEquals($data['result']['message']['to'][2]['position'], null);
        $this->assertEquals($data['result']['message']['to'][2]['interest'], null);
        $this->assertEquals($data['result']['message']['to'][2]['avatar'], null);
        $this->assertEquals(count($data['result']['message']['to'][2]['roles']), 1);
        $this->assertEquals($data['result']['message']['to'][2]['roles'][0], "admin");
        $this->assertEquals(count($data['result']['message']['to'][2]['program']), 0);
        $this->assertEquals($data['result']['message']['id'], 6);
    ...
    public function testCanMessageGetListByTypeDraft()
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]), 8);
        $this->assertEquals(count($data['result']['list'][0]['message']), 10);
        $this->assertEquals(count($data['result']['list'][0]['message']['from']), 0);
        ...
        $this->assertEquals(count($data['result']['list'][0]['message']['to']), 3);
        $this->assertEquals(count($data['result']['list'][0]['message']['to'][0]), 13);
        $this->assertEquals($data['result']['list'][0]['message']['to'][0]['contact_state'], 0);
        $this->assertEquals(count($data['result']['list'][0]['message']['to'][0]['school']), 4);
        $this->assertEquals($data['result']['list'][0]['message']['to'][0]['school']['id'], 1);
        ...
        $this->assertEquals(count($data['result']['list'][0]['message']['to'][1]['school']), 4);
        ...
        $this->assertEquals($data['result']['list'][0]['message']['to'][1]['id'], 2);
        $this->assertEquals($data['result']['list'][0]['message']['to'][1]['firstname'], "Xuan-Anh");
        $this->assertEquals($data['result']['list'][0]['message']['to'][1]['lastname'], "Hoang");
        $this->assertEquals($data['result']['list'][0]['message']['to'][1]['email'], "xhoang@thestudnet.com");
        ...
        $this->assertEquals(count($data['result']['list'][0]['message']['to'][2]), 13);
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['contact_state'], 0);
        $this->assertEquals(count($data['result']['list'][0]['message']['to'][2]['school']), 4);
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['school']['id'], 1);
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['school']['name'], "Morbi Corporation");
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['school']['short_name'], "turpis");
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['school']['logo'], null);
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['id'], 1);
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['firstname'], "Paul");
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['lastname'], "Boussekey");
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['email'], "pboussekey@thestudnet.com");
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['password'], "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['birth_date'], null);
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['position'], null);
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['interest'], null);
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['avatar'], null);
        $this->assertEquals(count($data['result']['list'][0]['message']['to'][2]['roles']), 1);
        $this->assertEquals($data['result']['list'][0]['message']['to'][2]['roles'][0], "admin");
        $this->assertEquals(count($data['result']['list'][0]['message']['to'][2]['program']), 0);
