...
class MessageTest extends AbstractService
{
    ...
    public function testCanSendMessage()
    {
        ...
        $this->assertEquals(count($data['result']['message']), 9);
    ...
    public function testCanGetList($conv)
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['message']), 9);
        ...
        $this->assertEquals(count($data['result']['list'][1]['message']), 9);
        ...
        $this->assertEquals(count($data['result']['list'][2]['message']), 9);
