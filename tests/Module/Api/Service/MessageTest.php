...
class MessageTest extends AbstractService
{
    ...
    public function testCanAddSendMail()
    {
        ...
        $this->assertEquals(count($data['result']['message']['document'][0]) , 4);
        ...
        $this->assertEquals(count($data['result']['message']['document'][1]) , 4);
    ...
    public function testCanMessageGetListByTypeDraft()
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['message']['document'][0]) , 4);
        ...
        $this->assertEquals(count($data['result']['list'][0]['message']['document'][1]) , 4);
