...
class AssignmentTest extends AbstractService
{
    ...
    public function testCanGetSubmissionContent($submission_id)
    {
        ...
        $this->assertEquals($data['result']['chat'][0]['users'][3]['nickname'], null);
        $this->assertEquals($data['result']['chat'][0]['users'][3]['avatar'], null);
        $this->assertEquals(count($data['result']['chat'][0]['users'][4]), 6);
        $this->assertEquals(count($data['result']['chat'][0]['users'][4]['roles']), 1);
        $this->assertEquals($data['result']['chat'][0]['users'][4]['roles'][0], "student");
        ...
        $this->assertEquals($data['result']['chat'][0]['users'][4]['nickname'], null);
        ...
        $this->assertEquals($data['result']['chat'][0]['conversation_opt']['nb_user_autorecord'], 2);
        $this->assertEquals($data['result']['chat'][0]['conversation_opt']['allow_intructor'], 1);
    ...
    public function testCanGetSubmissionAfterSubmit($item_id)
    {
        ...
        $this->assertEquals($data['result']['submission_user'][2]['grade'] , null);
        $this->assertEquals($data['result']['submission_user'][2]['submit_date'] , null);
        $this->assertEquals(!empty($data['result']['submission_user'][2]['start_date']) , true);
        $this->assertEquals($data['result']['id'] , 1);
        $this->assertEquals($data['result']['item_id'] , 1);
        $this->assertEquals($data['result']['group_id'] , null);
        $this->assertEquals($data['result']['group_name'] , null);
        $this->assertEquals($data['result']['submit_date'] , null);
        $this->assertEquals($data['result']['is_graded'] , 0);
        $this->assertEquals($data['result']['post_id'] , 1);
        $this->assertEquals($data['jsonrpc'] , 2.0);
    }
    ...
    public function testGetList($item_id)
    {
        ...
        $this->assertEquals($data['result'][0]['post_id'] , 1);
        $this->assertEquals($data['jsonrpc'] , 2.0);
    }
}
