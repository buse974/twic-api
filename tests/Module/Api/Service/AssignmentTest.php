...
class AssignmentTest extends AbstractService
{
    ...
    public function testGetList($item_id)
    {
        ...
        $this->assertEquals(count($data['result'][0]['submission_user'][0]) , 5);
        ...
        $this->assertEquals(count($data['result'][0]['submission_user'][1]) , 5);
        ...
        $this->assertEquals(count($data['result'][0]['submission_user'][2]) , 5);
