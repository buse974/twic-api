...
class EQCQTest extends AbstractService
{
    ...
    public function testAddDimension()
    {
        ...
        $data = $this->jsonRpc('dimension.add', array(
            'name' => 'Dimension',
            'describe' => 'une super dimension ',
        ));
    ...
    public function testUpdateDimension($dimension)
    {
        ...
        $data = $this->jsonRpc('dimension.update', array(
            'id' => $dimension,
            'name' => 'Dimension UPT',
            'describe' => 'une super dimension UPT',
        ));
     ...
     * @depends testAddDimension
     */
    public function testDeleteDimension($dimension)
    {
        $this->setIdentity(1);
    
        $data = $this->jsonRpc('dimension.delete', array(
            'id' => $dimension
        ));
