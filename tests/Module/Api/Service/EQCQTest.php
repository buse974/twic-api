...
class EQCQTest extends AbstractService
{
    ...
    public function testGetListQuestion($question)
    {
        ...
        $this->assertEquals(count($data) , 3);
        $this->assertEquals(count($data['result']) , 58);
        ...
        $this->assertEquals($data['result'][2]['component']['id'] , 2);
        $this->assertEquals($data['result'][2]['component']['name'] , "Multicultural sensitivity");
        ...
        $this->assertEquals($data['result'][3]['text'] , "\$subject realize(s) that because of different cultural backgrounds in our team, our perspectives may not be the same as those of team members from other regions.");
        ...
        $this->assertEquals($data['result'][4]['text'] , "\$subject believe(s)  that different cultural norms and values can affect business decisions in group work.");
        ...
        $this->assertEquals($data['result'][5]['component']['name'] , "Multicultural communication skill");
        $this->assertEquals($data['result'][5]['id'] , 7);
        $this->assertEquals($data['result'][5]['text'] , "\$subject adapt(s) my/his/her communication style to the cultural sensitivities in the group.");
        ...
        $this->assertEquals($data['result'][6]['id'] , 8);
        $this->assertEquals($data['result'][6]['text'] , "When interacting with team members from different countries, \$subject ask(s) questions to avoid misunderstanding.");
        ...
        $this->assertEquals($data['result'][7]['id'] , 9);
        $this->assertEquals($data['result'][7]['text'] , "In group meetings with people from different countries, \$subject never lose(s) patience and stop listening.");
        ...
        $this->assertEquals($data['result'][8]['component']['name'] , "Communication & presentation");
        $this->assertEquals($data['result'][8]['id'] , 10);
        $this->assertEquals($data['result'][8]['text'] , "\$subject am/is a good listener and pay(s) attention to what is being said by others.");
        ...
        $this->assertEquals($data['result'][9]['id'] , 11);
        $this->assertEquals($data['result'][9]['text'] , "\$subject am/is able to easily persuade other team members and win them over to my/his/her perspective.");
        ...
        $this->assertEquals($data['result'][10]['id'] , 12);
        $this->assertEquals($data['result'][10]['text'] , "Whenever there is conflict in the group, \$subject seek(s) feedback from others regarding his/her/my ability to try to manage it.");
        ...
        $this->assertEquals($data['result'][11]['id'] , 13);
        $this->assertEquals($data['result'][11]['text'] , "When other team members become stressed or confrontational, \$subject make(s) an effort to keep the conversation calm.");
        ...
        $this->assertEquals($data['result'][12]['id'] , 14);
        $this->assertEquals($data['result'][12]['text'] , "\$subject understand(s) how his/her/my behavior can affect others’ work and emotions in group work.");
        ...
        $this->assertEquals($data['result'][13]['id'] , 15);
        $this->assertEquals($data['result'][13]['text'] , "Even during emotionally charged arguments, \$subject remain(s) patient.");
        ...
        $this->assertEquals($data['result'][14]['id'] , 16);
        $this->assertEquals($data['result'][14]['text'] , "In stressful group work situations, \$subject never respond(s) too quickly or sharply.");
        ...
        $this->assertEquals($data['result'][15]['id'] , 17);
        $this->assertEquals($data['result'][15]['text'] , "\$subject am/is aware of my/his/her verbal outbursts during the team discussions.");
        ...
        $this->assertEquals($data['result'][16]['id'] , 18);
        $this->assertEquals($data['result'][16]['text'] , "\$subject adapt(s) my/his/her communication style to how others in the group are feeling.");
        ...
        $this->assertEquals($data['result'][17]['id'] , 19);
        $this->assertEquals($data['result'][17]['text'] , "\$subject always try/tries to find the best way to communicate with other team members, even when there is resistance, confusion or conflict.");
        ...
        $this->assertEquals($data['result'][18]['id'] , 20);
        $this->assertEquals($data['result'][18]['text'] , "\$subject like(s) to express opinions and share(s) ideas with others in the team.");
        ...
        $this->assertEquals($data['result'][19]['id'] , 21);
        $this->assertEquals($data['result'][19]['text'] , "\$subject enjoy(s) being on stage and presenting the recommendations of our group work to others.");
        ...
        $this->assertEquals($data['result'][20]['id'] , 22);
        $this->assertEquals($data['result'][20]['text'] , "During group discussions, \$subject frequently use(s) stories and metaphors to get my/his/her ideas and recommendations across more persuasively.");
        ...
        $this->assertEquals($data['result'][21]['id'] , 23);
        $this->assertEquals($data['result'][21]['text'] , "\$subject incorporate(s) other team members’ viewpoints into our group presentations.");
        ...
        $this->assertEquals($data['result'][22]['id'] , 24);
        $this->assertEquals($data['result'][22]['text'] , "\$subject never become(s) impatient when listening to team members.");
        ...
        $this->assertEquals($data['result'][23]['id'] , 25);
        $this->assertEquals($data['result'][23]['text'] , "During tense group discussions, \$subject never project(s) my/his/her stress and sense of urgency onto other people.");
        ...
        $this->assertEquals($data['result'][24]['id'] , 26);
        $this->assertEquals($data['result'][24]['text'] , "\$subject am/is an easy going and sociable person, and want(s) the team to work well together.");
        ...
        $this->assertEquals($data['result'][25]['id'] , 27);
        $this->assertEquals($data['result'][25]['text'] , "Whenever \$subject have/has a problem with the group assignment, \$subject will contact the other team members to find solutions.");
        ...
        $this->assertEquals($data['result'][26]['id'] , 28);
        $this->assertEquals($data['result'][26]['text'] , "Even when \$subject am/is angry or frustrated with the pace or quality of his/her/my group’s work, I/he/she remain(s) cool, calm and collected.");
        ...
        $this->assertEquals($data['result'][27]['id'] , 29);
        $this->assertEquals($data['result'][27]['text'] , "\$subject know(s) that I/he/she don’t/doesn’t work well under tight deadlines, so I/he/she get my/their part of the group work done well in advance.");
        ...
        $this->assertEquals($data['result'][28]['id'] , 30);
        $this->assertEquals($data['result'][28]['text'] , "When \$subject believe(s) that team members didn’t do a good job, I/he/she try/tries to understand the reasons for the failure and whether my/his/her actions or decisions had something to do with it.");
        ...
        $this->assertEquals($data['result'][29]['id'] , 31);
        $this->assertEquals($data['result'][29]['text'] , "During group work discussions, \$subject respectfully listen(s) to team members and then offer my/his/her opinions.");
        ...
        $this->assertEquals($data['result'][30]['id'] , 32);
        $this->assertEquals($data['result'][30]['text'] , "\$subject am/is interested in understanding team members’ points of view, and then offering some suggestions based on what they’re saying.");
        ...
        $this->assertEquals($data['result'][31]['id'] , 33);
        $this->assertEquals($data['result'][31]['text'] , "Even if \$subject thinks I/he/she have/has a better plan, I/he/she let others feel good about their ideas too");
        ...
        $this->assertEquals($data['result'][32]['id'] , 34);
        $this->assertEquals($data['result'][32]['text'] , "When our group project is criticized by the instructor, \$subject don’t/doesn’t blame others and instead try/tries to understand what we did wrong and how we can improve for the next round.");
        $this->assertEquals(count($data['result'][33]) , 3);
        $this->assertEquals(count($data['result'][33]['component']) , 2);
        $this->assertEquals($data['result'][33]['component']['id'] , 6);
        $this->assertEquals($data['result'][33]['component']['name'] , "Leadership");
        $this->assertEquals($data['result'][33]['id'] , 35);
        $this->assertEquals($data['result'][33]['text'] , "\$subject am/is able to manage my/his/her emotions in confrontational group work situations.");
        ...
        $this->assertEquals($data['result'][34]['id'] , 36);
        $this->assertEquals($data['result'][34]['text'] , "\$subject encourage(s) the participation of everyone on the team.");
        ...
        $this->assertEquals($data['result'][35]['id'] , 37);
        $this->assertEquals($data['result'][35]['text'] , "\$subject am/is able to build group pride, foster a positive emotional tone, and bring out the best in our team members.");
        ...
        $this->assertEquals($data['result'][36]['id'] , 38);
        $this->assertEquals($data['result'][36]['text'] , "\$subject always notice(s) when team members appear annoyed, frustrated or overwhelmed by my/his/her personality");
        ...
        $this->assertEquals($data['result'][37]['id'] , 39);
        $this->assertEquals($data['result'][37]['text'] , "Whenever team members don’t do what they were expected to do, \$subject deal(s) with it professionally and politely and explain(s) what had to be done differently.");
        ...
        $this->assertEquals($data['result'][38]['id'] , 40);
        $this->assertEquals($data['result'][38]['text'] , "\$subject can lead group discussions without team members feeling that they are being controlled.");
        ...
        $this->assertEquals($data['result'][39]['id'] , 41);
        $this->assertEquals($data['result'][39]['text'] , "\$subject always congratulate(s) team members for a job well-done.");
        ...
        $this->assertEquals($data['result'][40]['id'] , 42);
        $this->assertEquals($data['result'][40]['text'] , "Even if \$subject don’t/doesn’t like a team member, I/he/she will still work proactively with that person to get the job done.");
        ...
        $this->assertEquals($data['result'][41]['id'] , 43);
        $this->assertEquals($data['result'][41]['text'] , "\$subject take(s) other team members’ opinions into consideration when making decisions.");
        ...
        $this->assertEquals($data['result'][42]['id'] , 44);
        $this->assertEquals($data['result'][42]['text'] , "\$subject never blame(s) the team members when things go wrong.");
        ...
        $this->assertEquals($data['result'][43]['id'] , 45);
        $this->assertEquals($data['result'][43]['text'] , "\$subject use(s) “we” rather than “I” when describing our team’s accomplishments.");
        $this->assertEquals(count($data['result'][44]) , 3);
        $this->assertEquals(count($data['result'][44]['component']) , 2);
        $this->assertEquals($data['result'][44]['component']['id'] , 7);
        $this->assertEquals($data['result'][44]['component']['name'] , "Critical thinking");
        $this->assertEquals($data['result'][44]['id'] , 46);
        $this->assertEquals($data['result'][44]['text'] , "When discussing the problem to be solved within the group, \$subject am/is aware of how others perceive me/him/her.");
        ...
        $this->assertEquals($data['result'][45]['id'] , 47);
        $this->assertEquals($data['result'][45]['text'] , "In case work discussions on which managerial option to follow, \$subject am/is able to see the big picture and am/is not too narrowly focused.");
        ...
        $this->assertEquals($data['result'][46]['id'] , 48);
        $this->assertEquals($data['result'][46]['text'] , "During debate on which group decision to take, \$subject am/is able to consider issues from other team members’ perspectives.");
        ...
        $this->assertEquals($data['result'][47]['id'] , 49);
        $this->assertEquals($data['result'][47]['text'] , "In case study discussions, \$subject am/is easily able to identify the major issues confronting the organization and/or protagonists in the case.");
        ...
        $this->assertEquals($data['result'][48]['id'] , 50);
        $this->assertEquals($data['result'][48]['text'] , "When other team members suggest an alternative solution or recommendation to mine/his/her, \$subject listen(s) to them and weigh the pros and cons of the different options with all the team members.");
        $this->assertEquals(count($data['result'][49]) , 3);
        $this->assertEquals(count($data['result'][49]['component']) , 2);
        $this->assertEquals($data['result'][49]['component']['id'] , 8);
        $this->assertEquals($data['result'][49]['component']['name'] , "Empathy");
        $this->assertEquals($data['result'][49]['id'] , 51);
        $this->assertEquals($data['result'][49]['text'] , "\$subject am/is able to read the emotions of the team members.");
        ...
        $this->assertEquals($data['result'][50]['id'] , 52);
        $this->assertEquals($data['result'][50]['text'] , "\$subject easily build(s) relationships with almost everyone on the team.");
        ...
        $this->assertEquals($data['result'][52]['id'] , 54);
        $this->assertEquals($data['result'][52]['text'] , "\$subject understand(s) what motivates our team members, even those from different backgrounds.");
        ...
        $this->assertEquals($data['result'][53]['id'] , 55);
        $this->assertEquals($data['result'][53]['text'] , "\$subject am/is able to read other team members’ emotions and use that insight to create a positive and participative forum for group work discussions.");
        $this->assertEquals(count($data['result'][54]) , 3);
        $this->assertEquals(count($data['result'][54]['component']) , 2);
        $this->assertEquals($data['result'][54]['component']['id'] , 9);
        $this->assertEquals($data['result'][54]['component']['name'] , "Enthusiasm");
        $this->assertEquals($data['result'][54]['id'] , 56);
        $this->assertEquals($data['result'][54]['text'] , "\$subject always approach(es) a new group task, even if it means added work for me/him/her, enthusiastically.");
        ...
        $this->assertEquals($data['result'][55]['id'] , 57);
        $this->assertEquals($data['result'][55]['text'] , "\$subject really enjoy(s) it when the problem or issue that has to be solved as a team is a challenging and unexpected one.");
        ...
        $this->assertEquals($data['result'][56]['id'] , 58);
        $this->assertEquals($data['result'][56]['text'] , "Even when the instructor seemed harsh in the criticism of our group work, \$subject see(s) it as a way to improve for the next round.");
        ...
        $this->assertEquals($data['result'][57]['id'] , 59);
        $this->assertEquals($data['result'][57]['text'] , "\$subject never complain about the workload or the pace of work.");
        $this->assertEquals($data['id'] , 1);
        $this->assertEquals($data['jsonrpc'] , 2.0);
    }
    ...
    public function testGetListQuestionDeux($question)
    {
        ...
        $this->assertEquals($data['result']['list'][0]['component']['id'] , 3);
        $this->assertEquals($data['result']['list'][0]['component']['name'] , "Multicultural communication skill");
        $this->assertEquals($data['result']['list'][0]['id'] , 7);
        $this->assertEquals($data['result']['list'][0]['text'] , "\$subject adapt(s) my/his/her communication style to the cultural sensitivities in the group.");
        ...
        $this->assertEquals($data['result']['list'][1]['text'] , "When interacting with team members from different countries, \$subject ask(s) questions to avoid misunderstanding.");
        ...
        $this->assertEquals($data['result']['list'][2]['id'] , 9);
        $this->assertEquals($data['result']['list'][2]['text'] , "In group meetings with people from different countries, \$subject never lose(s) patience and stop listening.");
        $this->assertEquals($data['id'] , 1);
        $this->assertEquals($data['jsonrpc'] , 2.0);
