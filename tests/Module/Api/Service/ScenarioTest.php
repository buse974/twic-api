...
class ScenarioTest extends AbstractService
{
    ...
    public function testEventGetList()
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['source']['data']) , 5);
        ...
        $this->assertEquals(count($data['result']['list'][1]['source']['data']) , 5);
        ...
        $this->assertEquals(count($data['result']['list'][2]['source']['data']) , 5);
        ...
        $this->assertEquals(count($data['result']['list'][3]['source']['data']) , 5);
        ...
        $this->assertEquals(count($data['result']['list'][4]['source']['data']) , 5);
        ...
        $this->assertEquals(count($data['result']['list'][5]['source']['data']) , 5);
