...
class ScenarioTest extends AbstractService
{
    ...
    public function testCanGetListDetail()
    {
        ...
        $this->assertEquals(count($data['result'][0]['material_document'][3]), 12);
    ...
    public function testCanGetCoursesListByUser($program)
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['material_document'][0]), 12);
        ...
        $this->assertEquals(count($data['result']['list'][0]['material_document'][1]), 12);
        ...
        $this->assertEquals(count($data['result']['list'][0]['material_document'][2]), 12);
    ...
    public function testEventGetList()
    {
       ...
       $this->assertEquals(count($data['result']['list'][0]['source']['data']['school']) , 4);
       ...
       $this->assertEquals(count($data['result']['list'][1]['source']['data']['school']) , 4);
       ...
       $this->assertEquals(count($data['result']['list'][2]['source']['data']['school']) , 4);
       ...
       $this->assertEquals(count($data['result']['list'][3]['source']['data']['school']) , 4);
       ...
       $this->assertEquals(count($data['result']['list'][4]['source']['data']['school']) , 4);
       ...
       $this->assertEquals(count($data['result']['list'][5]['source']['data']['school']) , 4);
       ...
       $this->assertEquals(count($data['result']['list'][6]['source']['data']['school']) , 4);
       ...
       $this->assertEquals(count($data['result']['list'][7]['source']['data']['school']) , 4);
