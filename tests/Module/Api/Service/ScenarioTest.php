...
class ScenarioTest extends AbstractService
{
    ...
    public function testCanItemprogNbStart()
    {
        ...
        $this->assertEquals(count($data['result']['d']['LC']) , 1);
        $this->assertEquals(count($data['result']['d']['LC'][0]) , 2);
        $this->assertEquals($data['result']['d']['LC'][0]['started'] , null);
        $this->assertEquals($data['result']['d']['LC'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['d']['GW']) , 1);
        $this->assertEquals(count($data['result']['d']['GW'][0]) , 2);
        $this->assertEquals($data['result']['d']['GW'][0]['started'] , null);
        $this->assertEquals($data['result']['d']['GW'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['d']['CP']) , 1);
        $this->assertEquals(count($data['result']['d']['CP'][0]) , 2);
        $this->assertEquals($data['result']['d']['CP'][0]['submit'] , null);
        $this->assertEquals($data['result']['d']['CP'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['d']['IA']) , 1);
        $this->assertEquals(count($data['result']['d']['IA'][0]) , 2);
        $this->assertEquals($data['result']['d']['IA'][0]['submit'] , null);
        $this->assertEquals($data['result']['d']['IA'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['w']) , 4);
        $this->assertEquals(count($data['result']['w']['LC']) , 1);
        $this->assertEquals(count($data['result']['w']['LC'][0]) , 2);
        $this->assertEquals($data['result']['w']['LC'][0]['started'] , null);
        $this->assertEquals($data['result']['w']['LC'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['w']['GW']) , 1);
        $this->assertEquals(count($data['result']['w']['GW'][0]) , 2);
        $this->assertEquals($data['result']['w']['GW'][0]['started'] , null);
        $this->assertEquals($data['result']['w']['GW'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['w']['CP']) , 1);
        $this->assertEquals(count($data['result']['w']['CP'][0]) , 2);
        $this->assertEquals($data['result']['w']['CP'][0]['submit'] , null);
        $this->assertEquals($data['result']['w']['CP'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['w']['IA']) , 1);
        $this->assertEquals(count($data['result']['w']['IA'][0]) , 2);
        $this->assertEquals($data['result']['w']['IA'][0]['submit'] , null);
        $this->assertEquals($data['result']['w']['IA'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['m']) , 4);
        $this->assertEquals(count($data['result']['m']['LC']) , 1);
        $this->assertEquals(count($data['result']['m']['LC'][0]) , 2);
        $this->assertEquals($data['result']['m']['LC'][0]['started'] , null);
        $this->assertEquals($data['result']['m']['LC'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['m']['GW']) , 1);
        $this->assertEquals(count($data['result']['m']['GW'][0]) , 2);
        $this->assertEquals($data['result']['m']['GW'][0]['started'] , null);
        $this->assertEquals($data['result']['m']['GW'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['m']['CP']) , 1);
        $this->assertEquals(count($data['result']['m']['CP'][0]) , 2);
        $this->assertEquals($data['result']['m']['CP'][0]['submit'] , null);
        $this->assertEquals($data['result']['m']['CP'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['m']['IA']) , 1);
        $this->assertEquals(count($data['result']['m']['IA'][0]) , 2);
        $this->assertEquals($data['result']['m']['IA'][0]['submit'] , null);
        $this->assertEquals($data['result']['m']['IA'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['a']) , 4);
        $this->assertEquals(count($data['result']['a']['LC']) , 1);
        $this->assertEquals(count($data['result']['a']['LC'][0]) , 2);
        $this->assertEquals($data['result']['a']['LC'][0]['started'] , null);
        $this->assertEquals($data['result']['a']['LC'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['a']['GW']) , 1);
        $this->assertEquals(count($data['result']['a']['GW'][0]) , 2);
        $this->assertEquals($data['result']['a']['GW'][0]['started'] , null);
        $this->assertEquals($data['result']['a']['GW'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['a']['CP']) , 1);
        $this->assertEquals(count($data['result']['a']['CP'][0]) , 2);
        $this->assertEquals($data['result']['a']['CP'][0]['submit'] , null);
        $this->assertEquals($data['result']['a']['CP'][0]['total'] , 0);
        $this->assertEquals(count($data['result']['a']['IA']) , 1);
        $this->assertEquals(count($data['result']['a']['IA'][0]) , 2);
        $this->assertEquals($data['result']['a']['IA'][0]['submit'] , null);
        $this->assertEquals($data['result']['a']['IA'][0]['total'] , 0);
        $this->assertEquals($data['id'] , 1);
        $this->assertEquals($data['jsonrpc'] , 2.0);
    }
    ...
    public function testEventGetList()
    {
        ...
        $this->assertEquals($data['result']['list'][2]['event'] , "course.material_added");
        $this->assertEquals(count($data['result']['list'][2]['object']) , 3);
        $this->assertEquals($data['result']['list'][2]['object']['id'] , 1);
        $this->assertEquals($data['result']['list'][2]['object']['name'] , "course");
        $this->assertEquals(count($data['result']['list'][2]['object']['data']) , 3);
        $this->assertEquals($data['result']['list'][2]['object']['data']['title'] , "IMERIR");
        $this->assertEquals(count($data['result']['list'][2]['object']['data']['picture']) , 0);
        $this->assertEquals(count($data['result']['list'][2]['object']['data']['material']) , 6);
        $this->assertEquals($data['result']['list'][2]['object']['data']['material']['type'] , "type2");
        $this->assertEquals($data['result']['list'][2]['object']['data']['material']['title'] , "title2");
        $this->assertEquals($data['result']['list'][2]['object']['data']['material']['author'] , "author2");
        $this->assertEquals($data['result']['list'][2]['object']['data']['material']['link'] , "link2");
        ...
        $this->assertEquals($data['result']['list'][3]['event'] , "course.material_added");
        $this->assertEquals(count($data['result']['list'][3]['object']) , 3);
        $this->assertEquals($data['result']['list'][3]['object']['id'] , 1);
        $this->assertEquals($data['result']['list'][3]['object']['name'] , "course");
        $this->assertEquals(count($data['result']['list'][3]['object']['data']) , 3);
        $this->assertEquals($data['result']['list'][3]['object']['data']['title'] , "IMERIR");
        $this->assertEquals(count($data['result']['list'][3]['object']['data']['picture']) , 0);
        $this->assertEquals(count($data['result']['list'][3]['object']['data']['material']) , 6);
        $this->assertEquals($data['result']['list'][3]['object']['data']['material']['type'] , "type");
        $this->assertEquals($data['result']['list'][3]['object']['data']['material']['title'] , "title");
        $this->assertEquals($data['result']['list'][3]['object']['data']['material']['author'] , "author");
        $this->assertEquals($data['result']['list'][3]['object']['data']['material']['link'] , "link");
        ...
        $this->assertEquals(count($data['result']['list'][4]) , 8);
        ...
        $this->assertEquals($data['result']['list'][4]['source']['data']['user_roles'][0] , "admin");
        $this->assertEquals(!empty($data['result']['list'][4]['date']) , true);
        $this->assertEquals($data['result']['list'][4]['event'] , "course.updated");
        ...
        $this->assertEquals($data['result']['list'][4]['object']['data']['updated'][2] , "description");
        $this->assertEquals($data['result']['list'][4]['object']['data']['updated'][3] , "objectives");
        $this->assertEquals($data['result']['list'][4]['object']['data']['updated'][4] , "teaching");
        $this->assertEquals($data['result']['list'][4]['object']['data']['updated'][5] , "attendance");
        $this->assertEquals($data['result']['list'][4]['object']['data']['updated'][6] , "duration");
        $this->assertEquals($data['result']['list'][4]['object']['data']['updated'][7] , "notes");
        $this->assertEquals($data['result']['list'][4]['object']['data']['updated'][8] , "learning_outcomes");
        ...
        $this->assertEquals(count($data['result']['list'][5]) , 8);
        $this->assertEquals($data['result']['list'][5]['is_like'] , 0);
        $this->assertEquals($data['result']['list'][5]['read_date'] , null);
        $this->assertEquals($data['result']['list'][5]['id'] , 2);
        $this->assertEquals(count($data['result']['list'][5]['source']) , 3);
        $this->assertEquals($data['result']['list'][5]['source']['id'] , 1);
        $this->assertEquals($data['result']['list'][5]['source']['name'] , "user");
        $this->assertEquals(count($data['result']['list'][5]['source']['data']) , 7);
        $this->assertEquals($data['result']['list'][5]['source']['data']['firstname'] , "Paul");
        $this->assertEquals($data['result']['list'][5]['source']['data']['email'] , "pboussekey@thestudnet.com");
        $this->assertEquals($data['result']['list'][5]['source']['data']['lastname'] , "Boussekey");
        ...
        $this->assertEquals($data['result']['list'][5]['source']['data']['school']['id'] , 2);
        $this->assertEquals($data['result']['list'][5]['source']['data']['school']['short_name'] , "IUM");
        $this->assertEquals($data['result']['list'][5]['source']['data']['school']['logo'] , "token");
        $this->assertEquals(count($data['result']['list'][5]['source']['data']['user_roles']) , 1);
        $this->assertEquals($data['result']['list'][5]['source']['data']['user_roles'][0] , "admin");
        $this->assertEquals(!empty($data['result']['list'][5]['date']) , true);
        $this->assertEquals($data['result']['list'][5]['event'] , "profile.updated");
        $this->assertEquals(count($data['result']['list'][5]['object']) , 3);
        $this->assertEquals($data['result']['list'][5]['object']['id'] , 1);
        $this->assertEquals($data['result']['list'][5]['object']['name'] , "user");
        ...
        $this->assertEquals(count($data['result']['list'][6]) , 8);
        $this->assertEquals($data['result']['list'][6]['is_like'] , 0);
        $this->assertEquals($data['result']['list'][6]['read_date'] , null);
        $this->assertEquals($data['result']['list'][6]['id'] , 1);
        $this->assertEquals(count($data['result']['list'][6]['source']) , 0);
        $this->assertEquals(!empty($data['result']['list'][6]['date']) , true);
        $this->assertEquals($data['result']['list'][6]['event'] , "school.new");
        $this->assertEquals(count($data['result']['list'][6]['object']) , 3);
        $this->assertEquals($data['result']['list'][6]['object']['id'] , 2);
        $this->assertEquals($data['result']['list'][6]['object']['name'] , "school");
        $this->assertEquals(count($data['result']['list'][6]['object']['data']) , 4);
        $this->assertEquals($data['result']['list'][6]['object']['data']['id'] , 2);
        $this->assertEquals($data['result']['list'][6]['object']['data']['name'] , "université de monaco");
        $this->assertEquals($data['result']['list'][6]['object']['data']['short_name'] , "IUM");
        $this->assertEquals($data['result']['list'][6]['object']['data']['logo'] , "token");
