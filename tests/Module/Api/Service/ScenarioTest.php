...
class ScenarioTest extends AbstractService
{
    ...
    public function testCanGetConversation($conv)
    {
        ...
        $this->assertEquals(count($data['result']['messages']['list'][0]['message']) , 9);
    ...
    public function testCanJoinUser($videoconf)
    {
        ...
        $this->assertEquals(count($data['result']['conversations'][1]['messages']['list'][0]['message']) , 9);
        ...
        $this->assertEquals(count($data['result']['conversations'][2]['messages']['list'][0]['message']) , 9);
