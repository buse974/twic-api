...
class ScenarioTest extends AbstractService
{
    ...
    public function testCanGetListRecord()
    {
        ...
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][2]['avatar'], null);
        ...
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][3]['avatar'], null);
        ...
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][4]['avatar'], null);
    ...
    public function testCanGetConversation($conv)
    {
        ...
        $this->assertEquals(count($data['result']['messages'][0]), 8);
        ...
        $this->assertEquals($data['result']['messages'][0]['user']['avatar'], null);
        $this->assertEquals($data['result']['messages'][0]['id'], 7);
        $this->assertEquals($data['result']['messages'][0]['conversation_id'], 2);
        $this->assertEquals($data['result']['messages'][0]['from_id'], 3);
    ...
    public function testCanJoinUser($videoconf)
    {
        ...
        $this->assertEquals($data['result']['users'][5]['avatar'] , null);
        $this->assertEquals(count($data['result']['conversations']) , 2);
        $this->assertEquals(count($data['result']['conversations'][1]) , 3);
        $this->assertEquals(count($data['result']['conversations'][1]['users']) , 5);
        $this->assertEquals(count($data['result']['conversations'][1]['users'][1]) , 4);
        $this->assertEquals($data['result']['conversations'][1]['users'][1]['id'] , 1);
        $this->assertEquals($data['result']['conversations'][1]['users'][1]['firstname'] , "Paul");
        $this->assertEquals($data['result']['conversations'][1]['users'][1]['lastname'] , "Boussekey");
        $this->assertEquals($data['result']['conversations'][1]['users'][1]['avatar'] , null);
        $this->assertEquals(count($data['result']['conversations'][1]['users'][2]) , 4);
        $this->assertEquals($data['result']['conversations'][1]['users'][2]['id'] , 2);
        $this->assertEquals($data['result']['conversations'][1]['users'][2]['firstname'] , "Xuan-Anh");
        $this->assertEquals($data['result']['conversations'][1]['users'][2]['lastname'] , "Hoang");
        $this->assertEquals($data['result']['conversations'][1]['users'][2]['avatar'] , null);
        $this->assertEquals(count($data['result']['conversations'][1]['users'][3]) , 4);
        $this->assertEquals($data['result']['conversations'][1]['users'][3]['id'] , 3);
        $this->assertEquals($data['result']['conversations'][1]['users'][3]['firstname'] , "Christophe");
        $this->assertEquals($data['result']['conversations'][1]['users'][3]['lastname'] , "Robert");
        $this->assertEquals($data['result']['conversations'][1]['users'][3]['avatar'] , null);
        ...
        $this->assertEquals(count($data['result']['conversations'][1]['messages'][0]) , 8);
        ...
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user']['avatar'] , null);
        ...
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['from_id'] , 3);
        ...
        $this->assertEquals(count($data['result']['conversations'][2]['users'][2]) , 4);
        ...
        $this->assertEquals(count($data['result']['conversations'][2]['users'][3]) , 4);
        $this->assertEquals($data['result']['conversations'][2]['users'][3]['id'] , 3);
        $this->assertEquals($data['result']['conversations'][2]['users'][3]['firstname'] , "Christophe");
        $this->assertEquals($data['result']['conversations'][2]['users'][3]['lastname'] , "Robert");
        $this->assertEquals($data['result']['conversations'][2]['users'][3]['avatar'] , null);
        $this->assertEquals(count($data['result']['conversations'][2]['messages']) , 1);
        $this->assertEquals(count($data['result']['conversations'][2]['messages'][0]) , 8);
        ...
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user']['avatar'] , null);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['id'] , 7);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['conversation_id'] , 2);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['from_id'] , 3);
    ...
    public function testCanItemProgForCalendar($item_prog_user)
    {
        ...
        $this->assertEquals($data['result'][0]['users'][2]['avatar'], null);
        ...
        $this->assertEquals($data['result'][0]['users'][3]['avatar'], null);
        ...
        $this->assertEquals($data['result'][0]['users'][4]['avatar'], null);
    ...
    public function testCanGetItemsProgUSerByModule($module)
    {
        ...
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][2]['avatar'], null);
        ...
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][3]['avatar'], null);
        ...
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][4]['avatar'], null);
    ...
    public function testCangetListGrade($program, $course)
    {
        ...
        $this->assertEquals($data['result']['list'][0]['users'][2]['avatar'], null);
        ...
        $this->assertEquals($data['result']['list'][0]['users'][3]['avatar'], null);
        ...
        $this->assertEquals($data['result']['list'][0]['users'][4]['avatar'], null);
