...
class CourseTest extends AbstractService
{
    ...
    public function testProgramGetList()
    {
        ...
        $this->assertEquals(count($datas['result']['list'][0]) , 5);
        ...
        $this->assertEquals(count($datas['result']['list'][1]) , 5);
        ...
        $this->assertEquals(count($datas['result']['list'][2]) , 5);
        ...
        $this->assertEquals(count($datas['result']['list'][3]) , 5);
