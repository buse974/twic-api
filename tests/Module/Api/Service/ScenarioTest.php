...
class ScenarioTest extends AbstractService
{
    ...
    public function testCanGetListSchool()
    {
        ...
        $this->assertEquals($data['result']['list'][1]['address']['longitude'], 7.4246158);
        $this->assertEquals($data['result']['list'][1]['address']['latitude'], 43.7384176);
    ...
    public function testGetCourse($id)
    {
        ...
        $this->assertEquals(count($data['result']['instructor'][0]), 14);
    ...
    public function testCourseGetListOne($program)
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['student'][0]), 14);
        ...
        $this->assertEquals(count($data['result']['list'][0]['instructor'][0]), 14);
    ...
    public function testEventGetList()
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['source']['data']), 9);
        ...
        $this->assertEquals($data['result']['list'][0]['source']['data']['nickname'], null);
        ...
        $this->assertEquals(count($data['result']['list'][1]['source']['data']), 9);
        ...
        $this->assertEquals($data['result']['list'][1]['source']['data']['nickname'], null);
        ...
        $this->assertEquals(count($data['result']['list'][3]['source']['data']), 9);
        ...
        $this->assertEquals($data['result']['list'][3]['source']['data']['nickname'], null);
        ...
        $this->assertEquals(count($data['result']['list'][4]['source']['data']), 9);
        ...
        $this->assertEquals($data['result']['list'][4]['source']['data']['nickname'], null);
