...
class ScenarioTest extends AbstractService
{
    ...
    public function testGetCourse($id)
    {
        ...
        print_r($data['result']['school']); exit;
        $this->assertEquals(count($data) , 3); 
        ...
        $this->assertEquals(count($data['result']['instructor'][0]) , 11); 
        $this->assertEquals($data['result']['instructor'][0]['contact_state'] , 0); 
        $this->assertEquals(count($data['result']['instructor'][0]['school']) , 3); 
        ...
        $this->assertEquals($data['result']['instructor'][0]['avatar'] , "http://thestudnet.com/wp-content/uploads/2014/10/colSeb-e1424787940281.jpg"); 
        $this->assertEquals(count($data['result']['creator']) , 5); 
        $this->assertEquals(count($data['result']['creator']['school']) , 3); 
        $this->assertEquals($data['result']['creator']['school']['id'] , 2); 
        $this->assertEquals($data['result']['creator']['school']['name'] , "université de monaco"); 
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('itemprog.add', array('item' => $item,'start_date' => '2015-01-01 10:10','due_date' => '2016-01-01 10:10','users' => array(1,2,3,4)));
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('itemprog.update', array('id' => $item_prog,'start_date' => '2015-06-01 12:10','users' => array(5)));
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('itemprog.addUser', array('item_prog' => $item_prog,'user' => array(1,2,3,4)));
        
        $this->assertEquals(count($data), 3);
        $this->assertEquals(count($data['result']), 1);
        $this->assertEquals(count($data['result'][1]), 4);
        $this->assertEquals($data['result'][1][1], 1);
        $this->assertEquals($data['result'][1][2], 1);
        $this->assertEquals($data['result'][1][3], 1);
        $this->assertEquals($data['result'][1][4], 1);
        $this->assertEquals($data['id'], 1);
        $this->assertEquals($data['jsonrpc'], 2.0);
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('videoconf.validTransfertVideo', array('m_videoconf_id' => 1,'url' => 'urlvideo'));
    ...
    public function testCanGetListRecord()
    {
        ...
        $this->assertEquals(count($data['result']), 1);
        $this->assertEquals(count($data['result'][0]), 7);
        $this->assertEquals(count($data['result'][0]['school']), 2);
        ...
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][0]['id'], 1);
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][0]['firstname'], "Paul");
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][0]['lastname'], "Boussekey");
        ...
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][1]['id'], 2);
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][1]['firstname'], "Xuan-Anh");
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][1]['lastname'], "Hoang");
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][1]['avatar'], null);
        $this->assertEquals(count($data['result'][0]['items'][0]['item_prog'][0]['users'][2]), 4);
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][2]['id'], 3);
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][2]['firstname'], "Christophe");
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][2]['lastname'], "Robert");
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][2]['avatar'], "http://thestudnet.com/wp-content/uploads/2014/10/colchristophe-e1424779179460.png");
        $this->assertEquals(count($data['result'][0]['items'][0]['item_prog'][0]['users'][3]), 4);
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][3]['id'], 4);
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][3]['firstname'], "Salim");
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][3]['lastname'], "Bendacha");
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][3]['avatar'], "http://thestudnet.com/wp-content/uploads/2014/10/colsalim-e1424778081387.png");
        $this->assertEquals(count($data['result'][0]['items'][0]['item_prog'][0]['users'][4]), 4);
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][4]['id'], 5);
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][4]['firstname'], "Sébastien");
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][4]['lastname'], "Sayegh");
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['users'][4]['avatar'], "http://thestudnet.com/wp-content/uploads/2014/10/colSeb-e1424787940281.jpg");
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['id'], 1);
        $this->assertEquals($data['result'][0]['items'][0]['item_prog'][0]['start_date'], "2015-06-01T12:10:00Z");
    ...
    public function testCanGetByItemProg($item_prog)
    {
        ...
        $this->assertEquals($data['result']['archive_link'] , "urlvideo");
        $this->assertEquals($data['result']['item_prog_id'] , 1);
        $this->assertEquals($data['result']['archive_status'] , "available");
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('message.send', array('text' => 'Salut les copains', 'conversation' => 1));
        ...
        $this->assertEquals($data['result']['user']['avatar'] , "http://thestudnet.com/wp-content/uploads/2014/10/colchristophe-e1424779179460.png");
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('videoconf.addConversation', array('videoconf' => $videoconf, 'users' => array(2), 'text' => 'super text qui tue'));
    ...
    public function testCanGetConversation($conv)
    {
        ...
        $this->assertEquals(count($data['result']['users'][2]) , 2);
        $this->assertEquals($data['result']['users'][2]['conversation_id'] , 2);
        $this->assertEquals($data['result']['users'][2]['user_id'] , 2);
        $this->assertEquals(count($data['result']['users'][3]) , 2);
        $this->assertEquals($data['result']['users'][3]['conversation_id'] , 2);
        $this->assertEquals($data['result']['users'][3]['user_id'] , 3);
        $this->assertEquals(count($data['result']['messages']) , 1);
        $this->assertEquals(count($data['result']['messages'][0]) , 7);
        $this->assertEquals(count($data['result']['messages'][0]['message']) , 4);
        $this->assertEquals($data['result']['messages'][0]['message']['id'] , 2);
        $this->assertEquals($data['result']['messages'][0]['message']['text'] , "super text qui tue");
        $this->assertEquals($data['result']['messages'][0]['message']['token'] , null);
        $this->assertEquals(!empty($data['result']['messages'][0]['message']['created_date']) , true);
        $this->assertEquals(count($data['result']['messages'][0]['user']) , 4);
        $this->assertEquals($data['result']['messages'][0]['user']['id'] , 3);
        $this->assertEquals($data['result']['messages'][0]['user']['firstname'] , "Christophe");
        $this->assertEquals($data['result']['messages'][0]['user']['lastname'] , "Robert");
        $this->assertEquals($data['result']['messages'][0]['user']['avatar'] , "http://thestudnet.com/wp-content/uploads/2014/10/colchristophe-e1424779179460.png");
        $this->assertEquals($data['result']['messages'][0]['id'] , 6);
        $this->assertEquals($data['result']['messages'][0]['conversation_id'] , 2);
        $this->assertEquals($data['result']['messages'][0]['user_id'] , 3);
        $this->assertEquals($data['result']['messages'][0]['read_date'] , null);
        $this->assertEquals(!empty($data['result']['messages'][0]['created_date']) , true);
        $this->assertEquals($data['id'] , 1);
        $this->assertEquals($data['jsonrpc'] , 2.0);
    }
    ...
    public function testCanJoinUser($videoconf)
    {
        ...
        $this->assertEquals($data['result']['users'][3]['avatar'] , "http://thestudnet.com/wp-content/uploads/2014/10/colchristophe-e1424779179460.png");
        ...
        $this->assertEquals($data['result']['users'][4]['avatar'] , "http://thestudnet.com/wp-content/uploads/2014/10/colsalim-e1424778081387.png");
        $this->assertEquals(count($data['result']['users'][5]) , 4);
        $this->assertEquals($data['result']['users'][5]['id'] , 5);
        $this->assertEquals($data['result']['users'][5]['firstname'] , "Sébastien");
        $this->assertEquals($data['result']['users'][5]['lastname'] , "Sayegh");
        $this->assertEquals($data['result']['users'][5]['avatar'] , "http://thestudnet.com/wp-content/uploads/2014/10/colSeb-e1424787940281.jpg");
        $this->assertEquals(count($data['result']['conversations']) , 2);
        $this->assertEquals(count($data['result']['conversations'][1]) , 2);
        $this->assertEquals(count($data['result']['conversations'][1]['users']) , 4);
        $this->assertEquals(count($data['result']['conversations'][1]['users'][1]) , 2);
        $this->assertEquals($data['result']['conversations'][1]['users'][1]['conversation_id'] , 1);
        $this->assertEquals($data['result']['conversations'][1]['users'][1]['user_id'] , 1);
        $this->assertEquals(count($data['result']['conversations'][1]['users'][2]) , 2);
        $this->assertEquals($data['result']['conversations'][1]['users'][2]['conversation_id'] , 1);
        $this->assertEquals($data['result']['conversations'][1]['users'][2]['user_id'] , 2);
        $this->assertEquals(count($data['result']['conversations'][1]['users'][3]) , 2);
        $this->assertEquals($data['result']['conversations'][1]['users'][3]['conversation_id'] , 1);
        $this->assertEquals($data['result']['conversations'][1]['users'][3]['user_id'] , 3);
        $this->assertEquals(count($data['result']['conversations'][1]['users'][4]) , 2);
        $this->assertEquals($data['result']['conversations'][1]['users'][4]['conversation_id'] , 1);
        $this->assertEquals($data['result']['conversations'][1]['users'][4]['user_id'] , 4);
        $this->assertEquals(count($data['result']['conversations'][1]['messages']) , 1);
        $this->assertEquals(count($data['result']['conversations'][1]['messages'][0]) , 7);
        $this->assertEquals(count($data['result']['conversations'][1]['messages'][0]['message']) , 4);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['message']['id'] , 1);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['message']['text'] , "Salut les copains");
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['message']['token'] , null);
        $this->assertEquals(!empty($data['result']['conversations'][1]['messages'][0]['message']['created_date']) , true);
        $this->assertEquals(count($data['result']['conversations'][1]['messages'][0]['user']) , 4);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user']['id'] , 3);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user']['firstname'] , "Christophe");
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user']['lastname'] , "Robert");
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user']['avatar'] , "http://thestudnet.com/wp-content/uploads/2014/10/colchristophe-e1424779179460.png");
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['id'] , 3);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['conversation_id'] , 1);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user_id'] , 3);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['read_date'] , null);
        $this->assertEquals(!empty($data['result']['conversations'][1]['messages'][0]['created_date']) , true);
        $this->assertEquals(count($data['result']['conversations'][2]) , 2);
        $this->assertEquals(count($data['result']['conversations'][2]['users']) , 2);
        $this->assertEquals(count($data['result']['conversations'][2]['users'][2]) , 2);
        $this->assertEquals($data['result']['conversations'][2]['users'][2]['conversation_id'] , 2);
        $this->assertEquals($data['result']['conversations'][2]['users'][2]['user_id'] , 2);
        $this->assertEquals(count($data['result']['conversations'][2]['users'][3]) , 2);
        $this->assertEquals($data['result']['conversations'][2]['users'][3]['conversation_id'] , 2);
        $this->assertEquals($data['result']['conversations'][2]['users'][3]['user_id'] , 3);
        $this->assertEquals(count($data['result']['conversations'][2]['messages']) , 1);
        $this->assertEquals(count($data['result']['conversations'][2]['messages'][0]) , 7);
        $this->assertEquals(count($data['result']['conversations'][2]['messages'][0]['message']) , 4);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['message']['id'] , 2);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['message']['text'] , "super text qui tue");
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['message']['token'] , null);
        $this->assertEquals(!empty($data['result']['conversations'][2]['messages'][0]['message']['created_date']) , true);
        $this->assertEquals(count($data['result']['conversations'][2]['messages'][0]['user']) , 4);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user']['id'] , 3);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user']['firstname'] , "Christophe");
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user']['lastname'] , "Robert");
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user']['avatar'] , "http://thestudnet.com/wp-content/uploads/2014/10/colchristophe-e1424779179460.png");
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['id'] , 6);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['conversation_id'] , 2);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user_id'] , 3);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['read_date'] , null);
        $this->assertEquals(!empty($data['result']['conversations'][2]['messages'][0]['created_date']) , true);
        ...
        $this->assertEquals($data['result']['videoconf_admin']['user_id'] , 3);
    ...
    public function testCanItemProgForCalendar($item_prog_user)
    {
        ...
        $this->assertEquals($data['result'][0]['users'][0]['firstname'], "Paul");
        $this->assertEquals($data['result'][0]['users'][0]['lastname'], "Boussekey");
        $this->assertEquals($data['result'][0]['users'][0]['avatar'], null);
        $this->assertEquals(count($data['result'][0]['users'][1]), 4);
        $this->assertEquals($data['result'][0]['users'][1]['id'], 2);
        $this->assertEquals($data['result'][0]['users'][1]['firstname'], "Xuan-Anh");
        $this->assertEquals($data['result'][0]['users'][1]['lastname'], "Hoang");
        $this->assertEquals($data['result'][0]['users'][1]['avatar'], null);
        $this->assertEquals(count($data['result'][0]['users'][2]), 4);
    ...
    public function testCanGetTask()
    {
        ...
        $this->assertEquals($data['result'][0]['user']['avatar'], 'http://thestudnet.com/wp-content/uploads/2014/10/colchristophe-e1424779179460.png');
        ...
        $this->assertEquals($data['result'][0]['start'], "2015-06-02T12:00:00Z");
        $this->assertEquals($data['result'][0]['end'], "2015-06-02T13:30:00Z");
        $this->assertEquals($data['id'], 1);
        $this->assertEquals($data['jsonrpc'], 2.0);
    ...
    public function testCanGetItemsProgUSerByModule($module)
    {
        ...
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][0]['firstname'], "Paul");
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][0]['lastname'], "Boussekey");
        ...
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][1]['id'], 2);
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][1]['firstname'], "Xuan-Anh");
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][1]['lastname'], "Hoang");
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][1]['avatar'], null);
        $this->assertEquals(count($data['result'][0]['item_prog'][0]['users'][2]), 4);
    ...
    public function testCangetListGrade($program, $course)
    {
        ...
        $this->assertEquals($data['result']['list'][0]['item_prog']['item_assignment']['id'], 1);
        ...
        $this->assertEquals($data['result']['list'][0]['item_prog']['start_date'], "2015-06-01T12:10:00Z");
        $this->assertEquals($data['result']['list'][0]['item_prog']['due_date'], "2016-01-01T10:10:00Z");
        $this->assertEquals(count($data['result']['list'][0]['users']), 5);
        $this->assertEquals(count($data['result']['list'][0]['users'][0]), 4);
        $this->assertEquals($data['result']['list'][0]['users'][0]['id'], 1);
        $this->assertEquals($data['result']['list'][0]['users'][0]['firstname'], "Paul");
        $this->assertEquals($data['result']['list'][0]['users'][0]['lastname'], "Boussekey");
        $this->assertEquals($data['result']['list'][0]['users'][0]['avatar'], null);
        $this->assertEquals(count($data['result']['list'][0]['users'][1]), 4);
        $this->assertEquals($data['result']['list'][0]['users'][1]['id'], 2);
        $this->assertEquals($data['result']['list'][0]['users'][1]['firstname'], "Xuan-Anh");
        $this->assertEquals($data['result']['list'][0]['users'][1]['lastname'], "Hoang");
        $this->assertEquals($data['result']['list'][0]['users'][1]['avatar'], null);
        $this->assertEquals(count($data['result']['list'][0]['users'][2]), 4);
        $this->assertEquals($data['result']['list'][0]['users'][2]['id'], 3);
        $this->assertEquals($data['result']['list'][0]['users'][2]['firstname'], "Christophe");
        $this->assertEquals($data['result']['list'][0]['users'][2]['lastname'], "Robert");
        $this->assertEquals($data['result']['list'][0]['users'][2]['avatar'], 'http://thestudnet.com/wp-content/uploads/2014/10/colchristophe-e1424779179460.png');
        $this->assertEquals(count($data['result']['list'][0]['users'][3]), 4);
        $this->assertEquals($data['result']['list'][0]['users'][3]['id'], 4);
        $this->assertEquals($data['result']['list'][0]['users'][3]['firstname'], "Salim");
        $this->assertEquals($data['result']['list'][0]['users'][3]['lastname'], "Bendacha");
        $this->assertEquals($data['result']['list'][0]['users'][3]['avatar'], 'http://thestudnet.com/wp-content/uploads/2014/10/colsalim-e1424778081387.png');
        $this->assertEquals(count($data['result']['list'][0]['users'][4]), 4);
        $this->assertEquals($data['result']['list'][0]['users'][4]['id'], 5);
        $this->assertEquals($data['result']['list'][0]['users'][4]['firstname'], "Sébastien");
        $this->assertEquals($data['result']['list'][0]['users'][4]['lastname'], "Sayegh");
        $this->assertEquals($data['result']['list'][0]['users'][4]['avatar'], 'http://thestudnet.com/wp-content/uploads/2014/10/colSeb-e1424787940281.jpg');
    ...
    public function testCanGetListGradeDetail($course)
    {
        ...
        $data = $this->jsonRpc('item.getListGradeDetail', array('course' => $course,'user' => 1));
        $this->assertEquals(count($data), 3);
        $this->assertEquals(count($data['result']), 6);
        $this->assertEquals(count($data['result'][0]), 5);
    ...
    public function testUserGetList()
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['school']) , 3);
    ...
    public function testCanGetCoursesListByUser($program)
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['instructor'][0]['school']) , 3);
        ...
        $this->assertEquals($data['result']['list'][0]['instructor'][0]['avatar'] , "http://thestudnet.com/wp-content/uploads/2014/10/colSeb-e1424787940281.jpg");
    ...
    public function testGetItemAssignment($assignment)
    {
        ...
        $this->assertEquals(count($data['result']['item_prog']['item']['course']['instructor'][0]['school']) , 3);
        ...
        $this->assertEquals($data['result']['item_prog']['item']['course']['instructor'][0]['avatar'] , "http://thestudnet.com/wp-content/uploads/2014/10/colSeb-e1424787940281.jpg");
        ...
        $this->assertEquals($data['result']['students'][0]['firstname'] , "Paul");
        $this->assertEquals($data['result']['students'][0]['lastname'] , "Boussekey");
        $this->assertEquals($data['result']['students'][0]['avatar'] , null);
        $this->assertEquals(count($data['result']['students'][1]) , 4);
        $this->assertEquals($data['result']['students'][1]['id'] , 2);
        $this->assertEquals($data['result']['students'][1]['firstname'] , "Xuan-Anh");
        $this->assertEquals($data['result']['students'][1]['lastname'] , "Hoang");
        $this->assertEquals($data['result']['students'][1]['avatar'] , null);
        $this->assertEquals(count($data['result']['students'][2]) , 4);
        ...
        $this->assertEquals($data['result']['documents'][0]['item_assigment_id'] , 1);
