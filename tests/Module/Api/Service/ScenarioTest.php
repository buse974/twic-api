...
class ScenarioTest extends AbstractService
{
    ...
    public function testCanGetConversation($conv)
    {
        ...
        $this->assertEquals($data['result']['messages'][0]['id'] , 5);
    ...
    public function testCanJoinUser($videoconf)
    {
        ...
        $this->assertEquals($data['result']['users'][4]['lastname'] , "Bendacha");
        $this->assertEquals($data['result']['users'][4]['avatar'] , null);
        $this->assertEquals(count($data['result']['users'][7]) , 13);
        $this->assertEquals($data['result']['users'][7]['contact_state'] , 0);
        $this->assertEquals(count($data['result']['users'][7]['school']) , 4);
        $this->assertEquals($data['result']['users'][7]['school']['id'] , 1);
        $this->assertEquals($data['result']['users'][7]['school']['name'] , "Morbi Corporation");
        $this->assertEquals($data['result']['users'][7]['school']['short_name'] , "turpis");
        $this->assertEquals($data['result']['users'][7]['school']['logo'] , null);
        $this->assertEquals($data['result']['users'][7]['id'] , 5);
        $this->assertEquals($data['result']['users'][7]['firstname'] , "Sébastien");
        $this->assertEquals($data['result']['users'][7]['lastname'] , "Sayegh");
        $this->assertEquals($data['result']['users'][7]['email'] , "ssayegh@thestudnet.com");
        $this->assertEquals($data['result']['users'][7]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals($data['result']['users'][7]['birth_date'] , null);
        $this->assertEquals($data['result']['users'][7]['position'] , null);
        $this->assertEquals($data['result']['users'][7]['interest'] , null);
        $this->assertEquals($data['result']['users'][7]['avatar'] , null);
        $this->assertEquals(count($data['result']['users'][7]['roles']) , 1);
        $this->assertEquals($data['result']['users'][7]['roles'][0] , "instructor");
        ...
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user']['id'] , 4);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user']['firstname'] , "Salim");
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user']['lastname'] , "Bendacha");
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user']['avatar'] , null);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['id'] , 1);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['conversation_id'] , 1);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['from_id'] , 4);
        $this->assertEquals($data['result']['conversations'][1]['messages'][0]['user_id'] , 4);
        ...
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user']['id'] , 4);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user']['firstname'] , "Salim");
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user']['lastname'] , "Bendacha");
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user']['avatar'] , null);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['id'] , 4);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['conversation_id'] , 2);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['from_id'] , 4);
        $this->assertEquals($data['result']['conversations'][2]['messages'][0]['user_id'] , 4);
