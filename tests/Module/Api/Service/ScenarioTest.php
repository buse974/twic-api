...
class ScenarioTest extends AbstractService
{
    ...
    public function testEventGetList()
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['source']['data']['school']) , 3);
        ...
        $this->assertEquals(count($data['result']['list'][1]['source']['data']['school']) , 3);
        ...
        $this->assertEquals(count($data['result']['list'][2]['source']['data']['school']) , 3);
        ...
        $this->assertEquals(count($data['result']['list'][3]['source']['data']['school']) , 3);
        ...
        $this->assertEquals(count($data['result']['list'][4]['source']['data']['school']) , 3);
        ...
        $this->assertEquals(count($data['result']['list'][5]['source']['data']['school']) , 3);
        ...
        $this->assertEquals(count($data['result']['list'][6]['source']['data']['school']) , 3);
        ...
        $this->assertEquals(count($data['result']['list'][7]['source']['data']['school']) , 3);
