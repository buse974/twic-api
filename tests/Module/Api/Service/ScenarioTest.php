...
class CourseTest extends AbstractService
{
    ...
    public function testCanAddSchool()
    {
        ...
        $data = $this->jsonRpc('school.add', array('name' => 'université de monaco',
                ...
                'contact_id' => 1,
                'address' => array("street_no" => 12,
                    "street_type" => "rue",
                    "street_name" => "du stade",
                    "city" => array("name" => "Monaco"),
                    "country" => array("name" => "Monaco"
                    )
                )));
        ...
        $this->assertEquals($data['result']['address']['longitude'], 7.3999876);
        $this->assertEquals($data['result']['address']['latitude'], 43.7441142);
        ...
        $this->assertEquals($data['result']['contact_user']['firstname'], "Nicolas");
        $this->assertEquals($data['result']['contact_user']['lastname'], "Maremmani");
        $this->assertEquals($data['result']['contact_user']['status'], null);
        $this->assertEquals($data['result']['contact_user']['email'], "nmaremmani@thestudnet.com");
        ...
        $this->assertEquals($data['result']['id'], 102);
    ...
    public function testCanAddProgram($school_id)
    {
        ...
        $data = $this->jsonRpc('program.add', array('name' => 'program name',
                'school_id' => $school_id,
                'level' => 'emba',
                'sis' => 'sis'));

        $this->assertEquals(count($data), 3);
        $this->assertEquals($data['result'], 101);
        $this->assertEquals($data['id'], 1);
        $this->assertEquals($data['jsonrpc'], 2.0);
    ...
    public function testCanUpdateProgram($program_id)
    {
        ...
        $data = $this->jsonRpc('program.update', array('id' => $program_id,
    ...
    public function testAddCourse($school_id, $program_id)
    {
        ...
        $data = $this->jsonRpc('course.add', array('title' => 'IMERIR',
                'abstract' => 'un_token',
                ...
                'material_document' => array(array('type' => 'link',
                        'title' => 'title',
                        'author' => 'author',
                        'link' => 'link',
                        'source' => 'source',
        ...
        $this->assertEquals($data['result']['creator']['school']['id'], 1);
        $this->assertEquals($data['result']['creator']['school']['name'], "Tempor Limited");
        $this->assertEquals($data['result']['creator']['school']['logo'], null);
        $this->assertEquals($data['result']['creator']['id'], 1);
        $this->assertEquals($data['result']['creator']['firstname'], "Nicolas");
        $this->assertEquals($data['result']['creator']['lastname'], "Maremmani");
        $this->assertEquals($data['result']['creator']['email'], "nmaremmani@thestudnet.com");
        ...
        $this->assertEquals($data['result']['material_document'][0]['course_id'], 5);
        ...
        $this->assertEquals($data['result']['grading'][0]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][1]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][2]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][3]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][4]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][5]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][6]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][7]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][8]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][9]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][10]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading'][11]['school_id'], $school_id);
        ...
        $this->assertEquals($data['result']['grading_policy'][0]['course_id'], 5);
        ...
        $this->assertEquals($data['result']['grading_policy'][1]['course_id'], 5);
        ...
        $this->assertEquals($data['result']['grading_policy'][2]['course_id'], 5);
        ...
        $this->assertEquals($data['result']['grading_policy'][3]['course_id'], 5);
        ...
        $this->assertEquals($data['result']['grading_policy'][4]['course_id'], 5);
    ...
    public function testUpdateCourse($id)
    {
        ...
        $data = $this->jsonRpc('course.update', array('id' => $id,
                'title' => 'IMERIR',
                'abstract' => 'un_token',
                'description' => 'description',
                'objectives' => 'objectives',
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('materialdocument.add', array('course_id' => $course_id,
                'type' => 'type',
                'title' => 'title',
                'author' => 'author',
                'link' => 'link',
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('materialdocument.update', array('id' => $id,
                'type' => 'updatetype',
                'title' => 'updatetitle',
                'author' => 'updateauthor',
                'link' => 'updatelink',
    ...
    public function testAddItem($id, $material, $module)
    {
        ...
        $data = $this->jsonRpc('item.add', array('course' => $id,
                'grading_policy' => 6,
                'duration' => 234,
                'title' => 'title',
    ...
    public function testUpdateItem($id, $material)
    {
        ...
        $data = $this->jsonRpc('item.update', array('id' => $id,
                'grading_policy' => 8,
                'duration' => 123,
                'title' => 'titl2e',
                'describe' => 'description2',
    ...
    public function testCanGetListItem($course)
    {
        ...
        $this->assertEquals($data['result'][0]['course_id'], 5);
        ...
        $this->assertEquals($data['result'][1]['course_id'], 5);
    ...
    public function testGetCourse($id)
    {
        ...
        $this->assertEquals($data['result']['material_document'][1]['course_id'], 5);
        ...
        $this->assertEquals($data['result']['material_document'][2]['course_id'], 5);
        ...
        $this->assertEquals($data['result']['grading'][0]['description'], "Outstanding performance, works shows superior command of the subject.");
        $this->assertEquals($data['result']['grading'][0]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][0]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][1]), 8);
        $this->assertEquals($data['result']['grading'][1]['id'], 14);
        $this->assertEquals($data['result']['grading'][1]['letter'], "A-");
        $this->assertEquals($data['result']['grading'][1]['min'], 90);
        ...
        $this->assertEquals($data['result']['grading'][1]['description'], "Very good work showing understanding and mastery of all concepts.");
        $this->assertEquals($data['result']['grading'][1]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][1]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][2]), 8);
        $this->assertEquals($data['result']['grading'][2]['id'], 15);
        $this->assertEquals($data['result']['grading'][2]['letter'], "B+");
        $this->assertEquals($data['result']['grading'][2]['min'], 87);
        ...
        $this->assertEquals($data['result']['grading'][2]['description'], "Good work showing understanding and mastery of most concepts.");
        $this->assertEquals($data['result']['grading'][2]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][2]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][3]), 8);
        $this->assertEquals($data['result']['grading'][3]['id'], 16);
        $this->assertEquals($data['result']['grading'][3]['letter'], "B");
        $this->assertEquals($data['result']['grading'][3]['min'], 83);
        ...
        $this->assertEquals($data['result']['grading'][3]['description'], "Fairly good work that shows an understanding of the main concepts.");
        $this->assertEquals($data['result']['grading'][3]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][3]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][4]), 8);
        $this->assertEquals($data['result']['grading'][4]['id'], 17);
        $this->assertEquals($data['result']['grading'][4]['letter'], "B-");
        $this->assertEquals($data['result']['grading'][4]['min'], 80);
        ...
        $this->assertEquals($data['result']['grading'][4]['description'], "Fairly good work showing understanding of several important concepts.");
        $this->assertEquals($data['result']['grading'][4]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][4]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][5]), 8);
        $this->assertEquals($data['result']['grading'][5]['id'], 18);
        $this->assertEquals($data['result']['grading'][5]['letter'], "C+");
        $this->assertEquals($data['result']['grading'][5]['min'], 77);
        ...
        $this->assertEquals($data['result']['grading'][5]['description'], "Uneven understanding of the concepts with occasional lack of clarity");
        $this->assertEquals($data['result']['grading'][5]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][5]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][6]), 8);
        $this->assertEquals($data['result']['grading'][6]['id'], 19);
        $this->assertEquals($data['result']['grading'][6]['letter'], "C");
        $this->assertEquals($data['result']['grading'][6]['min'], 73);
        ...
        $this->assertEquals($data['result']['grading'][6]['description'], "Work that barely meets modest expectations for the class");
        $this->assertEquals($data['result']['grading'][6]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][6]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][7]), 8);
        $this->assertEquals($data['result']['grading'][7]['id'], 20);
        $this->assertEquals($data['result']['grading'][7]['letter'], "C-");
        $this->assertEquals($data['result']['grading'][7]['min'], 70);
        ...
        $this->assertEquals($data['result']['grading'][7]['description'], "Work that is below modest expectations for the class");
        $this->assertEquals($data['result']['grading'][7]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][7]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][8]), 8);
        $this->assertEquals($data['result']['grading'][8]['id'], 21);
        $this->assertEquals($data['result']['grading'][8]['letter'], "D+");
        $this->assertEquals($data['result']['grading'][8]['min'], 67);
        ...
        $this->assertEquals($data['result']['grading'][8]['description'], "Poor performance with lack of understanding of several important concepts");
        $this->assertEquals($data['result']['grading'][8]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][8]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][9]), 8);
        $this->assertEquals($data['result']['grading'][9]['id'], 22);
        $this->assertEquals($data['result']['grading'][9]['letter'], "D");
        $this->assertEquals($data['result']['grading'][9]['min'], 63);
        ...
        $this->assertEquals($data['result']['grading'][9]['description'], "Work that is marginally above the minimum expectations for the class");
        $this->assertEquals($data['result']['grading'][9]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][9]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][10]), 8);
        $this->assertEquals($data['result']['grading'][10]['id'], 23);
        $this->assertEquals($data['result']['grading'][10]['letter'], "D-");
        $this->assertEquals($data['result']['grading'][10]['min'], 60);
        ...
        $this->assertEquals($data['result']['grading'][10]['description'], "Work that barely meets the minimum expectations for the class");
        $this->assertEquals($data['result']['grading'][10]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][10]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading'][11]), 8);
        $this->assertEquals($data['result']['grading'][11]['id'], 24);
        $this->assertEquals($data['result']['grading'][11]['letter'], "F");
        $this->assertEquals($data['result']['grading'][11]['min'], 0);
        ...
        $this->assertEquals($data['result']['grading'][11]['description'], "Work does not meet the minimum expectations for the class");
        $this->assertEquals($data['result']['grading'][11]['tpl'], 0);
        $this->assertEquals($data['result']['grading'][11]['school_id'], 102);
        $this->assertEquals(count($data['result']['grading_policy']), 5);
        $this->assertEquals(count($data['result']['grading_policy'][0]), 7);
        $this->assertEquals($data['result']['grading_policy'][0]['id'], 6);
        $this->assertEquals($data['result']['grading_policy'][0]['name'], "Individual assignment");
    ...
    public function testgetGrading($id)
    {
        ...
        $this->assertEquals($data['result'][0]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][1]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][2]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][3]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][4]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][5]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][6]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][7]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][8]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][9]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][10]['school_id'], 102);
        ...
        $this->assertEquals($data['result'][11]['school_id'], 102);
        $this->assertEquals($data['id'], 1);
        $this->assertEquals($data['jsonrpc'], 2.0);
    }
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('grading.update', array('school' => $id,
                'datas' => array(array('letter' => 'A',
                        'min' => 5,
                        'max' => 50,
                        'grade' => 6.5,
                        'description' => 'description'),
    ...
    public function testGetGradingPolicy($id)
    {
        ...
        $this->assertEquals($data['result'][2]['tpl'], 0);
        $this->assertEquals($data['result'][2]['course_id'], 5);
        ...
        $this->assertEquals($data['result'][3]['tpl'], 0);
        $this->assertEquals($data['result'][3]['course_id'], 5);
        ...
        $this->assertEquals($data['result'][4]['tpl'], 0);
        $this->assertEquals($data['result'][4]['course_id'], 5);
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('gradingpolicy.add', array('course_id' => $id,
                'name' => 'tata',
                'grade' => 50));
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('gradingpolicy.update', array('datas' => array(array('id' => $id,
                          'name' => 'toto',
                          'grade' => 60))));
    ...
    public function testGetGradingPolicyAfter($id)
    {
        ...
        $this->assertEquals($data['result'][5]['tpl'], 0);
        $this->assertEquals($data['result'][5]['course_id'], 5);
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('itemprog.add', array('item' => $item,
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('itemprog.addUser', array('item_prog' => $item_prog,
                'user' => array(1, 2, 3, 4)));
    ...
    {
        $this->setIdentity(3);
        $data = $this->jsonRpc('itemassignment.add', array('item_prog' => $item_prog,
                'response' => 'response',
                'documents' => array(array('type' => 'type',
                        'title' => 'title',
                        'author' => 'author',
                        'link' => 'link',
                        'source' => 'source',
    ...
    public function testCangetListGrade($program)
    {
        ...
        $this->assertEquals($data['result']['list'][0]['program']['id'], 101);
        $this->assertEquals($data['result']['list'][0]['program']['name'], "program name upd");
        $this->assertEquals(count($data['result']['list'][0]['course']), 2);
        $this->assertEquals($data['result']['list'][0]['course']['id'], 5);
        $this->assertEquals($data['result']['list'][0]['course']['title'], "IMERIR");
        $this->assertEquals(count($data['result']['list'][0]['item_prog']), 1);
        $this->assertEquals($data['result']['list'][0]['item_prog']['start_date'], "0000-00-00 00:00:00");
        $this->assertEquals(count($data['result']['list'][0]['item_assignment']), 2);
        $this->assertEquals($data['result']['list'][0]['item_assignment']['id'], 1);
        $this->assertEquals(!empty($data['result']['list'][0]['item_assignment']['submit_date']),true);
        $this->assertEquals(count($data['result']['list'][0]['users']), 4);
        $this->assertEquals(count($data['result']['list'][0]['users'][0]), 3);
        $this->assertEquals($data['result']['list'][0]['users'][0]['id'], 1);
        $this->assertEquals($data['result']['list'][0]['users'][0]['firstname'], "Nicolas");
        $this->assertEquals($data['result']['list'][0]['users'][0]['lastname'], "Maremmani");
        $this->assertEquals(count($data['result']['list'][0]['users'][1]), 3);
        ...
        $this->assertEquals(count($data['result']['list'][0]['users'][2]), 3);
        ...
        $this->assertEquals(count($data['result']['list'][0]['users'][3]), 3);
        ...
        $this->assertEquals(count($data['result']['list'][0]['item_grade']), 3);
        $this->assertEquals($data['result']['list'][0]['item_grade']['letter'], null);
        $this->assertEquals($data['result']['list'][0]['item_grade']['grade'], null);
        $this->assertEquals($data['result']['list'][0]['item_grade']['created_date'], null);
    ...
    public function testCanGraded($item_assignment)
    {
        ...
        $data = $this->jsonRpc('itemassignment.setGrade', array('item_assignment' => $item_assignment,
                'score' => 50));
    ...
    public function testCangetListGradeTwo($program)
    {
        ...
        $this->assertEquals($data['result']['list'][0]['users'][3]['lastname'], "Bendacha");
        $this->assertEquals(count($data['result']['list'][0]['item_grade']), 3);
        $this->assertEquals($data['result']['list'][0]['item_grade']['letter'], "D-");
        $this->assertEquals($data['result']['list'][0]['item_grade']['grade'], 60);
        $this->assertEquals(!empty($data['result']['list'][0]['item_grade']['created_date']),true);
        $this->assertEquals($data['result']['list'][0]['new_message'], 1);
        $this->assertEquals($data['result']['list'][0]['title'], "titl2e");
        $this->assertEquals($data['id'], 1);
        $this->assertEquals($data['jsonrpc'], 2.0);
     ...
     */
    public function testCanGetListGradeDetail()
    {
    	$this->setIdentity(3);
    
    	$data = $this->jsonRpc('item.getListGradeDetail', array(
    		'course' => 5,
    		'user' => 1));
    	...
    	$this->assertEquals($data['result'][2]['name'] , "Live class");
    	$this->assertEquals($data['result'][2]['grade'] , 20);
    	$this->assertEquals(count($data['result'][3]) , 4);
    	$this->assertEquals($data['result'][3]['nbr_comment'] , 0);
    	$this->assertEquals($data['result'][3]['id'] , 9);
    	$this->assertEquals($data['result'][3]['name'] , "Capstone project");
    	$this->assertEquals($data['result'][3]['grade'] , 20);
    	$this->assertEquals(count($data['result'][4]) , 4);
    	$this->assertEquals($data['result'][4]['nbr_comment'] , 0);
    	$this->assertEquals($data['result'][4]['id'] , 10);
    	$this->assertEquals($data['result'][4]['name'] , "Attendance and participation");
    	$this->assertEquals($data['result'][4]['grade'] , 20);
    	$this->assertEquals(count($data['result'][5]) , 4);
    ...
    public function testAddFaqAsk($id)
    {
        ...
        $data = $this->jsonRpc('faq.add', array('ask' => 'une question',
                'answer' => 'une reponse',
                'course' => $id));
    ...
    public function testUpdateFaqAsk($faq)
    {
        ...
        $data = $this->jsonRpc('faq.update', array('id' => $faq,
    ...
    public function testProgramGetList()
    {
        ...
        $this->assertEquals($data['result']['list'][0]['student'], 11);
        $this->assertEquals($data['result']['list'][0]['instructor'], 6);
        $this->assertEquals($data['result']['list'][0]['course'], 4);
        $this->assertEquals($data['result']['list'][0]['id'], 46);
        $this->assertEquals($data['result']['list'][0]['name'], "ornare, lectus ante dictum");
        $this->assertEquals($data['result']['list'][0]['level'], "emba");
        $this->assertEquals($data['result']['list'][0]['sis'], "B8E");
        $this->assertEquals($data['result']['list'][0]['year'], null);
        $this->assertEquals(count($data['result']['list'][1]), 8);
        $this->assertEquals($data['result']['list'][1]['student'], 9);
        $this->assertEquals($data['result']['list'][1]['instructor'], 13);
        $this->assertEquals($data['result']['list'][1]['course'], 0);
        $this->assertEquals($data['result']['list'][1]['id'], 50);
        $this->assertEquals($data['result']['list'][1]['name'], "ac, fermentum vel, mauris.");
        $this->assertEquals($data['result']['list'][1]['level'], "mba");
        $this->assertEquals($data['result']['list'][1]['sis'], 614);
        $this->assertEquals($data['result']['list'][1]['year'], null);
        $this->assertEquals(count($data['result']['list'][2]), 8);
        $this->assertEquals($data['result']['list'][2]['student'], 10);
        $this->assertEquals($data['result']['list'][2]['instructor'], 7);
        $this->assertEquals($data['result']['list'][2]['course'], 0);
        $this->assertEquals($data['result']['list'][2]['id'], 69);
        $this->assertEquals($data['result']['list'][2]['name'], "neque vitae semper egestas,");
        $this->assertEquals($data['result']['list'][2]['level'], "mba");
        $this->assertEquals($data['result']['list'][2]['sis'], "5CC");
        $this->assertEquals($data['result']['list'][2]['year'], null);
        $this->assertEquals(count($data['result']['list'][3]), 8);
        $this->assertEquals($data['result']['list'][3]['student'], 5);
        $this->assertEquals($data['result']['list'][3]['instructor'], 7);
        $this->assertEquals($data['result']['list'][3]['course'], 0);
        $this->assertEquals($data['result']['list'][3]['id'], 78);
        $this->assertEquals($data['result']['list'][3]['name'], "Vivamus molestie dapibus ligula.");
        $this->assertEquals($data['result']['list'][3]['level'], "mba");
        $this->assertEquals($data['result']['list'][3]['sis'], "19C");
        $this->assertEquals($data['result']['list'][3]['year'], null);
    ...
    public function testUserGetList()
    {
        ...
        $data = $this->jsonRpc('user.getList', array('type' => array(), 'search' => 'orn'));

        $this->assertEquals(count($data), 3);
        $this->assertEquals(count($data['result']), 2);
        $this->assertEquals(count($data['result']['list']), 24);
        $this->assertEquals(count($data['result']['list'][0]), 12);
        $this->assertEquals(count($data['result']['list'][0]['school']), 3);
        $this->assertEquals($data['result']['list'][0]['school']['name'], "Tempor Limited");
        $this->assertEquals($data['result']['list'][0]['school']['short_name'], "ornare");
        $this->assertEquals($data['result']['list'][0]['school']['logo'], null);
        $this->assertEquals($data['result']['list'][0]['id'], 94);
        $this->assertEquals($data['result']['list'][0]['firstname'], "Hannah");
        $this->assertEquals($data['result']['list'][0]['lastname'], "Henry");
        $this->assertEquals($data['result']['list'][0]['email'], "tellus.sem.mollis@CuraePhasellus.org");
        $this->assertEquals($data['result']['list'][0]['password'], "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($data['result']['list'][0]['birth_date']), true);
        $this->assertEquals($data['result']['list'][0]['position'], "amet massa. Quisque");
        $this->assertEquals($data['result']['list'][0]['interest'], "erat. Vivamus nisi. Mauris nulla. Integer urna. Vivamus molestie dapibus");
        $this->assertEquals($data['result']['list'][0]['avatar'], null);
        $this->assertEquals(count($data['result']['list'][0]['roles']), 1);
        $this->assertEquals($data['result']['list'][0]['roles'][0], "instructor");
        $this->assertEquals(count($data['result']['list'][0]['program']), 1);
        $this->assertEquals(count($data['result']['list'][0]['program'][0]), 5);
        $this->assertEquals($data['result']['list'][0]['program'][0]['id'], 46);
        $this->assertEquals($data['result']['list'][0]['program'][0]['name'], "ornare, lectus ante dictum");
        $this->assertEquals($data['result']['list'][0]['program'][0]['level'], "emba");
        $this->assertEquals($data['result']['list'][0]['program'][0]['sis'], "B8E");
        $this->assertEquals($data['result']['list'][0]['program'][0]['year'], null);
        $this->assertEquals(count($data['result']['list'][1]), 12);
        $this->assertEquals(count($data['result']['list'][1]['school']), 3);
        $this->assertEquals($data['result']['list'][1]['school']['name'], "Tempor Limited");
        $this->assertEquals($data['result']['list'][1]['school']['short_name'], "ornare");
        $this->assertEquals($data['result']['list'][1]['school']['logo'], null);
        $this->assertEquals($data['result']['list'][1]['id'], 88);
        $this->assertEquals($data['result']['list'][1]['firstname'], "Risa");
        $this->assertEquals($data['result']['list'][1]['lastname'], "Edwards");
        $this->assertEquals($data['result']['list'][1]['email'], "elementum@aliquamiaculis.com");
        $this->assertEquals($data['result']['list'][1]['password'], "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($data['result']['list'][1]['birth_date']), true);
        $this->assertEquals($data['result']['list'][1]['position'], "vel nisl.");
        $this->assertEquals($data['result']['list'][1]['interest'], "id enim. Curabitur massa. Vestibulum accumsan neque et nunc. Quisque");
        $this->assertEquals($data['result']['list'][1]['avatar'], null);
        $this->assertEquals(count($data['result']['list'][1]['roles']), 1);
        $this->assertEquals($data['result']['list'][1]['roles'][0], "student");
        $this->assertEquals(count($data['result']['list'][1]['program']), 1);
        $this->assertEquals(count($data['result']['list'][1]['program'][0]), 5);
        $this->assertEquals($data['result']['list'][1]['program'][0]['id'], 46);
        $this->assertEquals($data['result']['list'][1]['program'][0]['name'], "ornare, lectus ante dictum");
        $this->assertEquals($data['result']['list'][1]['program'][0]['level'], "emba");
        $this->assertEquals($data['result']['list'][1]['program'][0]['sis'], "B8E");
        $this->assertEquals($data['result']['list'][1]['program'][0]['year'], null);
        $this->assertEquals(count($data['result']['list'][2]), 12);
        $this->assertEquals(count($data['result']['list'][2]['school']), 3);
        $this->assertEquals($data['result']['list'][2]['school']['name'], "Tempor Limited");
        $this->assertEquals($data['result']['list'][2]['school']['short_name'], "ornare");
        $this->assertEquals($data['result']['list'][2]['school']['logo'], null);
        $this->assertEquals($data['result']['list'][2]['id'], 77);
        $this->assertEquals($data['result']['list'][2]['firstname'], "Malcolm");
        $this->assertEquals($data['result']['list'][2]['lastname'], "Becker");
        $this->assertEquals($data['result']['list'][2]['email'], "placerat.Cras.dictum@libero.com");
        $this->assertEquals($data['result']['list'][2]['password'], "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($data['result']['list'][2]['birth_date']), true);
        $this->assertEquals($data['result']['list'][2]['position'], "metus sit amet");
        $this->assertEquals($data['result']['list'][2]['interest'], "convallis convallis dolor. Quisque tincidunt");
        $this->assertEquals($data['result']['list'][2]['avatar'], null);
        $this->assertEquals(count($data['result']['list'][2]['roles']), 1);
        $this->assertEquals($data['result']['list'][2]['roles'][0], "academic");
        $this->assertEquals(count($data['result']['list'][2]['program']), 1);
        $this->assertEquals(count($data['result']['list'][2]['program'][0]), 5);
        $this->assertEquals($data['result']['list'][2]['program'][0]['id'], 46);
        $this->assertEquals($data['result']['list'][2]['program'][0]['name'], "ornare, lectus ante dictum");
        $this->assertEquals($data['result']['list'][2]['program'][0]['level'], "emba");
        $this->assertEquals($data['result']['list'][2]['program'][0]['sis'], "B8E");
        $this->assertEquals($data['result']['list'][2]['program'][0]['year'], null);
    }
    ...
    public function testCanAddUserCourse($course)
    {
        ...
        $this->assertEquals($data['result'][1][5], 1);
        $this->assertEquals($data['id'], 1);
        $this->assertEquals($data['jsonrpc'], 2.0);
    }
    ...
    public function testCanGetCoursesListByUser($program)
    {
        ...
        $this->assertEquals($data['result']['list'][0]['id'] , 5);
    ...
    public function testAddThread($course)
    {
        ...
        $data = $this->jsonRpc('thread.add', array('title' => 'un titre',
                'course' => $course));
    ...
    public function testUpdateThread($thread)
    {
        ...
        $data = $this->jsonRpc('thread.update', array('title' => 'un titre update',
                'id' => $thread));
    ...
    public function testAddThreadMessage($thread)
    {
        ...
        $data = $this->jsonRpc('threadmessage.add', array('message' => 'un super message',
                'thread' => $thread));
    ...
    public function testUpdateThreadMessage($threadmessage)
    {
        ...
        $data = $this->jsonRpc('threadmessage.update', array('message' => 'un super message update',
                'id' => $threadmessage));
    ...
    public function testCourseGetList($program)
    {
    	...
    	$data = $this->jsonRpc('course.getList', array(
    			'program' => $program,
    			'search' => 'ME'
    	));
    ...
    function testDeleteCourse($id
        ...
        $this->assertEquals(count($data), 3);
        $this->assertEquals(count($data['result']), 1);
        $this->assertEquals($data['result'][5], true);
        $this->assertEquals($data['id'], 1);
        $this->assertEquals($data['jsonrpc'], 2.0);
    }
