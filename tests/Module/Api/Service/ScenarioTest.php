...
class ScenarioTest extends AbstractService
{
    ...
    public function testCanGetListItem($course)
    {
        ...
        $this->assertEquals($data['result'][1]['checked'] , 0);
        ...
        $this->assertEquals($data['result'][2]['checked'] , 3);
        $this->assertEquals($data['id'] , 1);
        $this->assertEquals($data['jsonrpc'] , 2.0);
    }
    ...
    public function testCanGetListItemuu($course)
    {
    	...
    	$this->assertEquals(count($data['result'][0]) , 19);
...
*/
    ...
    */
    ...
    public function testGetAnswer($item)
    {
        ...
        $this->assertEquals($data['result']['answers'][0]['question_id'] , 4);
