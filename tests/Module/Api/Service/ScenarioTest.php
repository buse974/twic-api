...
class CourseTest extends AbstractService
{
    ...
    public function testProgramGetList()
    {
        ...
        $this->assertEquals(count($datas['result']['list'][0]['student']) , 11);
        $this->assertEquals(count($datas['result']['list'][0]['student'][0]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][0]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][0]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][0]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][0]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][0]['id'] , 88);
        $this->assertEquals($datas['result']['list'][0]['student'][0]['firstname'] , "Risa");
        $this->assertEquals($datas['result']['list'][0]['student'][0]['lastname'] , "Edwards");
        $this->assertEquals($datas['result']['list'][0]['student'][0]['email'] , "elementum@aliquamiaculis.com");
        $this->assertEquals($datas['result']['list'][0]['student'][0]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][0]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][0]['position'] , "vel nisl.");
        $this->assertEquals($datas['result']['list'][0]['student'][0]['interest'] , "id enim. Curabitur massa. Vestibulum accumsan neque et nunc. Quisque");
        $this->assertEquals($datas['result']['list'][0]['student'][0]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][0]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][0]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][0]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][0]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][0]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][0]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][0]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][0]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][0]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][1]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][1]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][1]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][1]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][1]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][1]['id'] , 74);
        $this->assertEquals($datas['result']['list'][0]['student'][1]['firstname'] , "Cyrus");
        $this->assertEquals($datas['result']['list'][0]['student'][1]['lastname'] , "Britt");
        $this->assertEquals($datas['result']['list'][0]['student'][1]['email'] , "auctor.odio.a@consequatenim.co.uk");
        $this->assertEquals($datas['result']['list'][0]['student'][1]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][1]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][1]['position'] , "penatibus et");
        $this->assertEquals($datas['result']['list'][0]['student'][1]['interest'] , "Aliquam ornare, libero at auctor");
        $this->assertEquals($datas['result']['list'][0]['student'][1]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][1]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][1]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][1]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][1]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][1]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][1]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][1]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][1]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][1]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][2]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][2]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][2]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][2]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][2]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][2]['id'] , 70);
        $this->assertEquals($datas['result']['list'][0]['student'][2]['firstname'] , "Thane");
        $this->assertEquals($datas['result']['list'][0]['student'][2]['lastname'] , "Roman");
        $this->assertEquals($datas['result']['list'][0]['student'][2]['email'] , "Integer@eleifendnec.com");
        $this->assertEquals($datas['result']['list'][0]['student'][2]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][2]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][2]['position'] , "Aenean eget");
        $this->assertEquals($datas['result']['list'][0]['student'][2]['interest'] , "malesuada augue ut lacus. Nulla tincidunt, neque vitae");
        $this->assertEquals($datas['result']['list'][0]['student'][2]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][2]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][2]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][2]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][2]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][2]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][2]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][2]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][2]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][2]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][3]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][3]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][3]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][3]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][3]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][3]['id'] , 69);
        $this->assertEquals($datas['result']['list'][0]['student'][3]['firstname'] , "Dalton");
        $this->assertEquals($datas['result']['list'][0]['student'][3]['lastname'] , "Rosario");
        $this->assertEquals($datas['result']['list'][0]['student'][3]['email'] , "Aliquam.vulputate@afelis.net");
        $this->assertEquals($datas['result']['list'][0]['student'][3]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][3]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][3]['position'] , "iaculis enim, sit");
        $this->assertEquals($datas['result']['list'][0]['student'][3]['interest'] , "dis parturient montes, nascetur ridiculus mus.");
        $this->assertEquals($datas['result']['list'][0]['student'][3]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][3]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][3]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][3]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][3]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][3]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][3]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][3]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][3]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][3]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][4]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][4]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][4]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][4]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][4]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][4]['id'] , 68);
        $this->assertEquals($datas['result']['list'][0]['student'][4]['firstname'] , "Buckminster");
        $this->assertEquals($datas['result']['list'][0]['student'][4]['lastname'] , "Whitfield");
        $this->assertEquals($datas['result']['list'][0]['student'][4]['email'] , "mollis.non@Nuncquisarcu.co.uk");
        $this->assertEquals($datas['result']['list'][0]['student'][4]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][4]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][4]['position'] , "natoque penatibus");
        $this->assertEquals($datas['result']['list'][0]['student'][4]['interest'] , "facilisi. Sed neque. Sed eget lacus. Mauris");
        $this->assertEquals($datas['result']['list'][0]['student'][4]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][4]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][4]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][4]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][4]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][4]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][4]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][4]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][4]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][4]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][5]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][5]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][5]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][5]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][5]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][5]['id'] , 66);
        $this->assertEquals($datas['result']['list'][0]['student'][5]['firstname'] , "Myles");
        $this->assertEquals($datas['result']['list'][0]['student'][5]['lastname'] , "Kidd");
        $this->assertEquals($datas['result']['list'][0]['student'][5]['email'] , "eget@ornare.ca");
        $this->assertEquals($datas['result']['list'][0]['student'][5]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][5]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][5]['position'] , "consectetuer adipiscing");
        $this->assertEquals($datas['result']['list'][0]['student'][5]['interest'] , "parturient montes, nascetur ridiculus mus. Donec dignissim magna a tortor.");
        $this->assertEquals($datas['result']['list'][0]['student'][5]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][5]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][5]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][5]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][5]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][5]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][5]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][5]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][5]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][5]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][6]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][6]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][6]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][6]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][6]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][6]['id'] , 49);
        $this->assertEquals($datas['result']['list'][0]['student'][6]['firstname'] , "Callie");
        $this->assertEquals($datas['result']['list'][0]['student'][6]['lastname'] , "Woods");
        $this->assertEquals($datas['result']['list'][0]['student'][6]['email'] , "dictum.eu@sedduiFusce.edu");
        $this->assertEquals($datas['result']['list'][0]['student'][6]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][6]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][6]['position'] , "per conubia nostra,");
        $this->assertEquals($datas['result']['list'][0]['student'][6]['interest'] , "Etiam laoreet, libero et tristique pellentesque, tellus sem mollis");
        $this->assertEquals($datas['result']['list'][0]['student'][6]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][6]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][6]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][6]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][6]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][6]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][6]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][6]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][6]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][6]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][7]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][7]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][7]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][7]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][7]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][7]['id'] , 41);
        $this->assertEquals($datas['result']['list'][0]['student'][7]['firstname'] , "Branden");
        $this->assertEquals($datas['result']['list'][0]['student'][7]['lastname'] , "Glover");
        $this->assertEquals($datas['result']['list'][0]['student'][7]['email'] , "malesuada.Integer@Quisquenonummyipsum.com");
        $this->assertEquals($datas['result']['list'][0]['student'][7]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][7]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][7]['position'] , "augue malesuada");
        $this->assertEquals($datas['result']['list'][0]['student'][7]['interest'] , "ipsum primis in faucibus orci luctus et ultrices posuere cubilia");
        $this->assertEquals($datas['result']['list'][0]['student'][7]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][7]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][7]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][7]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][7]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][7]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][7]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][7]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][7]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][7]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][8]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][8]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][8]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][8]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][8]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][8]['id'] , 36);
        $this->assertEquals($datas['result']['list'][0]['student'][8]['firstname'] , "Arsenio");
        $this->assertEquals($datas['result']['list'][0]['student'][8]['lastname'] , "Mejia");
        $this->assertEquals($datas['result']['list'][0]['student'][8]['email'] , "in@Sedeueros.net");
        $this->assertEquals($datas['result']['list'][0]['student'][8]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][8]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][8]['position'] , "nibh dolor, nonummy");
        $this->assertEquals($datas['result']['list'][0]['student'][8]['interest'] , "Vivamus non lorem vitae odio");
        $this->assertEquals($datas['result']['list'][0]['student'][8]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][8]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][8]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][8]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][8]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][8]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][8]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][8]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][8]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][8]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][9]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][9]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][9]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][9]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][9]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][9]['id'] , 24);
        $this->assertEquals($datas['result']['list'][0]['student'][9]['firstname'] , "Emma");
        $this->assertEquals($datas['result']['list'][0]['student'][9]['lastname'] , "Norman");
        $this->assertEquals($datas['result']['list'][0]['student'][9]['email'] , "vitae@tellusNunclectus.com");
        $this->assertEquals($datas['result']['list'][0]['student'][9]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][9]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][9]['position'] , "consectetuer, cursus");
        $this->assertEquals($datas['result']['list'][0]['student'][9]['interest'] , "In at pede. Cras vulputate velit");
        $this->assertEquals($datas['result']['list'][0]['student'][9]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][9]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][9]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][9]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][9]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][9]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][9]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][9]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][9]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][9]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][10]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['student'][10]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['student'][10]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['student'][10]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['student'][10]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['student'][10]['id'] , 13);
        $this->assertEquals($datas['result']['list'][0]['student'][10]['firstname'] , "Ora");
        $this->assertEquals($datas['result']['list'][0]['student'][10]['lastname'] , "Bentley");
        $this->assertEquals($datas['result']['list'][0]['student'][10]['email'] , "auctor@interdumlibero.ca");
        $this->assertEquals($datas['result']['list'][0]['student'][10]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['student'][10]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['student'][10]['position'] , "in lobortis tellus");
        $this->assertEquals($datas['result']['list'][0]['student'][10]['interest'] , "nec tempus scelerisque, lorem ipsum sodales purus,");
        $this->assertEquals($datas['result']['list'][0]['student'][10]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['student'][10]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['student'][10]['roles'][0] , "student");
        $this->assertEquals(count($datas['result']['list'][0]['student'][10]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['student'][10]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['student'][10]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['student'][10]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['student'][10]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['student'][10]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['student'][10]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor']) , 6);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][0]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][0]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['id'] , 94);
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['firstname'] , "Hannah");
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['lastname'] , "Henry");
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['email'] , "tellus.sem.mollis@CuraePhasellus.org");
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['instructor'][0]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['position'] , "amet massa. Quisque");
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['interest'] , "erat. Vivamus nisi. Mauris nulla. Integer urna. Vivamus molestie dapibus");
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][0]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['roles'][0] , "instructor");
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][0]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][0]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['instructor'][0]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][1]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][1]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['id'] , 65);
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['firstname'] , "Preston");
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['lastname'] , "Barrera");
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['email'] , "purus.in@id.com");
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['instructor'][1]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['position'] , "consectetuer, cursus et,");
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['interest'] , "a, enim. Suspendisse aliquet, sem ut cursus luctus, ipsum");
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][1]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['roles'][0] , "instructor");
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][1]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][1]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['instructor'][1]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][2]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][2]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['id'] , 63);
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['firstname'] , "Mia");
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['lastname'] , "Acevedo");
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['email'] , "dolor@ipsum.net");
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['instructor'][2]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['position'] , "fringilla est.");
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['interest'] , "Mauris magna. Duis dignissim tempor arcu. Vestibulum ut");
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][2]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['roles'][0] , "instructor");
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][2]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][2]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['instructor'][2]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][3]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][3]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['id'] , 60);
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['firstname'] , "Amir");
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['lastname'] , "Dudley");
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['email'] , "elit.pharetra@Aliquameratvolutpat.org");
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['instructor'][3]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['position'] , "eget metus.");
        $this->assertEquals(!empty($datas['result']['list'][0]['instructor'][3]['interest']) , true);
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][3]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['roles'][0] , "instructor");
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][3]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][3]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['instructor'][3]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][4]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][4]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['id'] , 37);
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['firstname'] , "Hasad");
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['lastname'] , "Valentine");
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['email'] , "justo@Loremipsum.ca");
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['instructor'][4]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['position'] , "mi. Duis");
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['interest'] , "eget tincidunt dui augue eu tellus. Phasellus elit pede,");
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][4]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['roles'][0] , "instructor");
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][4]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][4]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['instructor'][4]['program'][0]['year'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][5]) , 12);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][5]['school']) , 3);
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['school']['name'] , "Tempor Limited");
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['school']['short_name'] , "ornare");
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['school']['logo'] , null);
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['id'] , 27);
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['firstname'] , "Desiree");
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['lastname'] , "Hooper");
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['email'] , "nisi.Cum@adipiscing.edu");
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['password'] , "4ac91ac4cb1614b368e3dff3ac718f1d");
        $this->assertEquals(!empty($datas['result']['list'][0]['instructor'][5]['birth_date']) , true);
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['position'] , "Duis dignissim");
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['interest'] , "lacinia mattis. Integer eu lacus. Quisque imperdiet, erat nonummy ultricies");
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['avatar'] , null);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][5]['roles']) , 1);
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['roles'][0] , "instructor");
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][5]['program']) , 1);
        $this->assertEquals(count($datas['result']['list'][0]['instructor'][5]['program'][0]) , 5);
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['program'][0]['id'] , 46);
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['program'][0]['name'] , "ornare, lectus ante dictum");
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['program'][0]['level'] , "emba");
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['program'][0]['sis'] , "B8E");
        $this->assertEquals($datas['result']['list'][0]['instructor'][5]['program'][0]['year'] , null);
