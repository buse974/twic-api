...
class ScenarioTest extends AbstractService
{
    ...
    public function testCanAddSchool()
    {
        ...
        $this->assertEquals(! empty($data['result']['address']['longitude']), false);
        $this->assertEquals(! empty($data['result']['address']['latitude']), false);
        ...
        $this->assertEquals($data['result']['address']['timezone'], null);
        $this->assertEquals(count($data['result']['contact_user']), 10);
        ...
        $this->assertEquals($data['result']['contact_user']['nickname'], null);
        ...
        $this->assertEquals($data['result']['type'], 'SCHOOL');
    ...
    public function testCanGetListSchool()
    {
        ...
        $this->assertEquals($data['result']['list'][0]['address'], null);
        ...
        $this->assertEquals($data['result']['list'][0]['type'], "SCHOOL");
        ...
        $this->assertEquals($data['result']['list'][1]['address']['division'], null);
        ...
        $this->assertEquals($data['result']['list'][1]['type'], "SCHOOL");
        $this->assertEquals($data['jsonrpc'], 2.0);
    }
    ...
    public function testAddCourse($school_id, $program_id)
    {
        ...
        $this->assertEquals(count($data['result']['creator']), 6);
        ...
        $this->assertEquals($data['result']['creator']['nickname'], null);
     ...
     * @depends testAddItemTwo
     */
    public function testCanGetListItem($course_id)
    {
        $this->setIdentity(1);

        $data = $this->jsonRpc('item.getList', array('course' => $course_id));

        //print_r($data);
        // "\n3:2:1\n";
        //@TODO vérifier l'ordre selon l'arboressence
        ...
        $this->assertEquals($data['result'][0]['order_id'] , 2);
    ...
    //@TODO Les test suivant sont commenté car il testé la pagination qui est désactivé et gérer coté UI a voir dans les prochaine realaese si on la rétablie.
    /**
     * @depends testAddCourse
     * @depends testAddItem
     * @depends testAddItemTwo
    ...
    /*public function testCanGetListItemuu($course)
    {
        ...
        $this->jsonRpc('item.update', ['id' => 1,'duration' => 123,'title' => 'titl2e','describe' => 'description2','order_id' => 2]);

        $this->reset();

        $this->setIdentity(1);

        $data = $this->jsonRpc('item.getList', ['course' => $course]);
    ...
    public function testCanGetSubmission($item_id)
    {
        ...
        $this->assertEquals($data['result']['post_id'] , null);
        $this->assertEquals($data['jsonrpc'] , 2.0);
    }
    ...
    public function testGetCourse($id)
    {
        ...
        $this->assertEquals(count($data['result']['instructor'][0]) , 16);
        ...
        $this->assertEquals($data['result']['instructor'][0]['email_sent'] , 1);
        ...
        $this->assertEquals($data['result']['instructor'][0]['ambassador'] , null);
        $this->assertEquals($data['result']['instructor'][0]['suspension_date'] , null);
        $this->assertEquals($data['result']['instructor'][0]['suspension_reason'] , null);
        $this->assertEquals(count($data['result']['creator']) , 6);
        $this->assertEquals(count($data['result']['creator']['school']) , 3);
        $this->assertEquals($data['result']['creator']['school']['id'] , 3);
        $this->assertEquals($data['result']['creator']['school']['name'] , "université de monaco");
    ...
    public function testCourseGetListOne($program)
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['student'][0]) , 16);
        ...
        $this->assertEquals($data['result']['list'][0]['student'][0]['email_sent'] , 1);
        ...
        $this->assertEquals($data['result']['list'][0]['student'][0]['ambassador'] , null);
        $this->assertEquals($data['result']['list'][0]['student'][0]['suspension_date'] , null);
        $this->assertEquals($data['result']['list'][0]['student'][0]['suspension_reason'] , null);
        $this->assertEquals(count($data['result']['list'][0]['instructor']) , 1);
        $this->assertEquals(count($data['result']['list'][0]['instructor'][0]) , 16);
        ...
        $this->assertEquals($data['result']['list'][0]['instructor'][0]['email_sent'] , 1);
        ...
        $this->assertEquals($data['result']['list'][0]['instructor'][0]['ambassador'] , null);
        $this->assertEquals($data['result']['list'][0]['instructor'][0]['suspension_date'] , null);
        $this->assertEquals($data['result']['list'][0]['instructor'][0]['suspension_reason'] , null);
        $this->assertEquals($data['result']['list'][0]['id'] , 1);
    ...
    public function testGetThread($course)
    {
        ...
        $this->assertEquals(count($data['result']['list'][0]['message']['user']), 5);
        ...
        $this->assertEquals($data['result']['list'][0]['message']['user']['nickname'], null);
        ...
        $this->assertEquals(count($data['result']['list'][0]['user']), 6);
    ...
    public function testUserGetList()
    {
        ...
        $this->assertEquals($data['result']['list'][0]['email_sent'] , 1);
        ...
        $this->assertEquals($data['result']['list'][0]['suspension_date'] , null);
        $this->assertEquals($data['result']['list'][0]['suspension_reason'] , null);
    ...
    public function testGetListThreadMessage($thread)
    {
        ...
        $this->assertEquals(count($data['result'][0]['parent']['user']), 5);
        ...
        $this->assertEquals($data['result'][0]['parent']['user']['nickname'], null);
        ...
        $this->assertEquals(count($data['result'][0]['user']), 6);
        ...
        $this->assertEquals(count($data['result'][1]['parent']['user']), 5);
        ...
        $this->assertEquals($data['result'][1]['parent']['user']['nickname'], null);
        ...
        $this->assertEquals(count($data['result'][1]['user']), 6);
        ...
        $this->assertEquals($data['result'][1]['user']['nickname'], null);
    ...
    public function testGetThreadOnlyOne($thread)
    {
        ...
        $this->assertEquals(count($data['result']['message']['user']), 5);
        ...
        $this->assertEquals($data['result']['message']['user']['nickname'], null);
