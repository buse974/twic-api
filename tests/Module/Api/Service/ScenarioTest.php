...
class CourseTest extends AbstractService
{
    ...
    public function testCanAddSchool()
    {
        ...
        $this->assertEquals(
            $datas['result']['address']['city']['name'], "Monaco"
        );
        $this->assertEquals(count($datas['result']['address']['division']), 2);
        $this->assertEquals(
            $datas['result']['address']['division']['id'], null
        );
        $this->assertEquals(
            $datas['result']['address']['division']['name'], null
        );
        $this->assertEquals(count($datas['result']['address']['country']), 3);
        $this->assertEquals($datas['result']['address']['country']['id'], 145);
        $this->assertEquals(
            $datas['result']['address']['country']['short_name'], "Monaco"
        );
        $this->assertEquals(
            $datas['result']['address']['country']['name'], "Principality of Monaco"
        );
        ...
        $this->assertEquals(
            $datas['result']['address']['street_name'], "du stade"
        );
        $this->assertEquals(
            $datas['result']['address']['longitude'], 7.3999876
        );
        $this->assertEquals(
            $datas['result']['address']['latitude'], 43.7441142
        );
        ...
        $this->assertEquals(
            $datas['result']['address']['timezone'], "Europe/Paris"
        );
        $this->assertEquals(count($datas['result']['contact_user']), 9);
        $this->assertEquals($datas['result']['contact_user']['id'], 1);
        $this->assertEquals(
            $datas['result']['contact_user']['firstname'], "Nicolas"
        );
        $this->assertEquals(
            $datas['result']['contact_user']['lastname'], "Maremmani"
        );
        $this->assertEquals($datas['result']['contact_user']['status'], null);
        $this->assertEquals(
            $datas['result']['contact_user']['email'], "nmaremmani@thestudnet.com"
        );
        $this->assertEquals(
            $datas['result']['contact_user']['birth_date'], null
        );
    ...
    public function testGetCourse($id)
    {
        ...
        $this->assertEquals(
            count($datas['result']['material_document'][1]), 12
        );
        $this->assertEquals($datas['result']['material_document'][1]['id'], 2);
        $this->assertEquals(
            $datas['result']['material_document'][1]['course_id'], 5
        );
        $this->assertEquals(
            $datas['result']['material_document'][1]['type'], "updatetype"
        );
        $this->assertEquals(
            $datas['result']['material_document'][1]['title'], "updatetitle"
        );
        $this->assertEquals(
            $datas['result']['material_document'][1]['author'], "updateauthor"
        );
        $this->assertEquals(
            $datas['result']['material_document'][1]['link'], "updatelink"
        );
        $this->assertEquals(
            $datas['result']['material_document'][1]['source'], "updatesrc"
        );
        $this->assertEquals(
            $datas['result']['material_document'][1]['token'], "updatetoken"
        );
        $this->assertEquals(
            $datas['result']['material_document'][1]['date'], "2015-01-10"
        );
        $this->assertEquals(
            !empty($datas['result']['material_document'][1]['created_date']),
            true
        );
        $this->assertEquals(
            $datas['result']['material_document'][1]['deleted_date'], null
        );
        $this->assertEquals(
            !empty($datas['result']['material_document'][1]['updated_date']),
            true
        );
        $this->assertEquals(
            count($datas['result']['material_document'][2]), 12
        );
        $this->assertEquals($datas['result']['material_document'][2]['id'], 3);
        $this->assertEquals(
            $datas['result']['material_document'][2]['course_id'], 5
        );
        $this->assertEquals(
            $datas['result']['material_document'][2]['type'], "type2"
        );
        $this->assertEquals(
            $datas['result']['material_document'][2]['title'], "title2"
        );
        $this->assertEquals(
            $datas['result']['material_document'][2]['author'], "author2"
        );
        $this->assertEquals(
            $datas['result']['material_document'][2]['link'], "link2"
        );
        $this->assertEquals(
            $datas['result']['material_document'][2]['source'], "src2"
        );
        $this->assertEquals(
            $datas['result']['material_document'][2]['token'], "token2"
        );
        $this->assertEquals(
            $datas['result']['material_document'][2]['date'], "2015-01-02"
        );
        $this->assertEquals(
            !empty($datas['result']['material_document'][2]['created_date']),
            true
        );
        $this->assertEquals(
            $datas['result']['material_document'][2]['deleted_date'], null
        );
        $this->assertEquals(
            $datas['result']['material_document'][2]['updated_date'], null
        );
        $this->assertEquals(count($datas['result']['grading']), 12);
        $this->assertEquals(count($datas['result']['grading'][0]), 8);
        $this->assertEquals($datas['result']['grading'][0]['id'], 13);
    ...
    public function testGetGradingPolicy($id)
    {
        ...
        $this->assertEquals(
            $datas['result'][0]['name'], "Individual assignment"
        );
        ...
        $this->assertEquals(
            $datas['result'][4]['name'], "Attendance and participation"
        );
    ...
    public function testCanAddCommentItemAssigment($item_assignment)
    {
        $this->setIdentity(3);
        $datas = $this->jsonRpc(
            'itemassignment.addComment', array(
                'text'            => 'text text text',
    ...
    public function testCangetListGrade($program)
    {
        ...
        $this->assertEquals(
            $datas['result']['list'][0]['module']['title'], null
        );
        $this->assertEquals(count($datas['result']['list'][0]['program']), 2);
        $this->assertEquals($datas['result']['list'][0]['program']['id'], 101);
        $this->assertEquals(
            $datas['result']['list'][0]['program']['name'], "program name upd"
        );
        $this->assertEquals(count($datas['result']['list'][0]['course']), 2);
        $this->assertEquals($datas['result']['list'][0]['course']['id'], 5);
        $this->assertEquals(
            $datas['result']['list'][0]['course']['title'], "IMERIR"
        );
        $this->assertEquals(count($datas['result']['list'][0]['item_prog']), 1);
        $this->assertEquals(
            $datas['result']['list'][0]['item_prog']['start_date'], "0000-00-00 00:00:00"
        );
        $this->assertEquals(
            count($datas['result']['list'][0]['item_assignment']), 2
        );
        $this->assertEquals(
            $datas['result']['list'][0]['item_assignment']['id'], 1
        );
        $this->assertEquals(
            !empty($datas['result']['list'][0]['item_assignment']['submit_date']),
            true
        );
        ...
        $this->assertEquals(
            $datas['result']['list'][0]['users'][0]['firstname'], "Nicolas"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['users'][0]['lastname'], "Maremmani"
        );
        $this->assertEquals(count($datas['result']['list'][0]['users'][1]), 3);
        $this->assertEquals($datas['result']['list'][0]['users'][1]['id'], 2);
        $this->assertEquals(
            $datas['result']['list'][0]['users'][1]['firstname'], "Xuan-Anh"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['users'][1]['lastname'], "Hoang"
        );
        $this->assertEquals(count($datas['result']['list'][0]['users'][2]), 3);
        $this->assertEquals($datas['result']['list'][0]['users'][2]['id'], 3);
        $this->assertEquals(
            $datas['result']['list'][0]['users'][2]['firstname'], "Christophe"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['users'][2]['lastname'], "Robert"
        );
        $this->assertEquals(count($datas['result']['list'][0]['users'][3]), 3);
        $this->assertEquals($datas['result']['list'][0]['users'][3]['id'], 4);
        $this->assertEquals(
            $datas['result']['list'][0]['users'][3]['firstname'], "Salim"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['users'][3]['lastname'], "Bendacha"
        );
        $this->assertEquals(
            count($datas['result']['list'][0]['item_grade']), 3
        );
        $this->assertEquals(
            $datas['result']['list'][0]['item_grade']['letter'], null
        );
        $this->assertEquals(
            $datas['result']['list'][0]['item_grade']['grade'], null
        );
        $this->assertEquals(
            $datas['result']['list'][0]['item_grade']['created_date'], null
        );
    ...
    public function testCangetListGradeTwo($program)
    {
        ...
        $this->assertEquals(
            $datas['result']['list'][0]['item_grade']['letter'], "D-"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['item_grade']['grade'], 60
        );
        $this->assertEquals(
            !empty($datas['result']['list'][0]['item_grade']['created_date']),
            true
        );
        $this->assertEquals($datas['result']['list'][0]['new_message'], 1);
        $this->assertEquals($datas['result']['list'][0]['title'], "titl2e");
    ...
    public function testGetList($course)
    {
        ...
        $this->assertEquals(
            $datas['result'][0]['answer'], "une reponse update"
        );
        $this->assertEquals($datas['result'][0]['course_id'], 5);
    ...
    public function testProgramGetList()
    {
        ...
        $this->assertEquals(
            $datas['result']['list'][0]['name'], "ornare, lectus ante dictum"
        );
        ...
        $this->assertEquals(
            $datas['result']['list'][1]['name'], "ac, fermentum vel, mauris."
        );
        ...
        $this->assertEquals(
            $datas['result']['list'][2]['name'], "neque vitae semper egestas,"
        );
        ...
        $this->assertEquals(
            $datas['result']['list'][3]['name'], "Vivamus molestie dapibus ligula."
        );
    ...
    public function testUserGetList()
    {
        ...
        $datas = $this->jsonRpc(
            'user.getList', array('type' => array(), 'search' => 'orn')
        );
        ...
        $this->assertEquals(
            $datas['result']['list'][0]['school']['name'], "Tempor Limited"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['school']['short_name'], "ornare"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['school']['logo'], null
        );
        ...
        $this->assertEquals(
            $datas['result']['list'][0]['email'], "tellus.sem.mollis@CuraePhasellus.org"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['password'], "4ac91ac4cb1614b368e3dff3ac718f1d"
        );
        $this->assertEquals(
            !empty($datas['result']['list'][0]['birth_date']), true
        );
        $this->assertEquals(
            $datas['result']['list'][0]['position'], "amet massa. Quisque"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['interest'], "erat. Vivamus nisi. Mauris nulla. Integer urna. Vivamus molestie dapibus"
        );
        $this->assertEquals($datas['result']['list'][0]['avatar'], null);
        $this->assertEquals(count($datas['result']['list'][0]['roles']), 1);
        $this->assertEquals(
            $datas['result']['list'][0]['roles'][0], "instructor"
        );
        $this->assertEquals(count($datas['result']['list'][0]['program']), 1);
        $this->assertEquals(
            count($datas['result']['list'][0]['program'][0]), 5
        );
        $this->assertEquals(
            $datas['result']['list'][0]['program'][0]['id'], 46
        );
        $this->assertEquals(
            $datas['result']['list'][0]['program'][0]['name'], "ornare, lectus ante dictum"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['program'][0]['level'], "emba"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['program'][0]['sis'], "B8E"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['program'][0]['year'], null
        );
        $this->assertEquals(count($datas['result']['list'][1]), 12);
        $this->assertEquals(count($datas['result']['list'][1]['school']), 3);
        $this->assertEquals(
            $datas['result']['list'][1]['school']['name'], "Tempor Limited"
        );
        $this->assertEquals(
            $datas['result']['list'][1]['school']['short_name'], "ornare"
        );
        $this->assertEquals(
            $datas['result']['list'][1]['school']['logo'], null
        );
        ...
        $this->assertEquals(
            $datas['result']['list'][1]['email'], "elementum@aliquamiaculis.com"
        );
        $this->assertEquals(
            $datas['result']['list'][1]['password'], "4ac91ac4cb1614b368e3dff3ac718f1d"
        );
        $this->assertEquals(
            !empty($datas['result']['list'][1]['birth_date']), true
        );
        $this->assertEquals(
            $datas['result']['list'][1]['position'], "vel nisl."
        );
        $this->assertEquals(
            $datas['result']['list'][1]['interest'], "id enim. Curabitur massa. Vestibulum accumsan neque et nunc. Quisque"
        );
        ...
        $this->assertEquals(
            count($datas['result']['list'][1]['program'][0]), 5
        );
        $this->assertEquals(
            $datas['result']['list'][1]['program'][0]['id'], 46
        );
        $this->assertEquals(
            $datas['result']['list'][1]['program'][0]['name'], "ornare, lectus ante dictum"
        );
        $this->assertEquals(
            $datas['result']['list'][1]['program'][0]['level'], "emba"
        );
        $this->assertEquals(
            $datas['result']['list'][1]['program'][0]['sis'], "B8E"
        );
        $this->assertEquals(
            $datas['result']['list'][1]['program'][0]['year'], null
        );
        $this->assertEquals(count($datas['result']['list'][2]), 12);
        $this->assertEquals(count($datas['result']['list'][2]['school']), 3);
        $this->assertEquals(
            $datas['result']['list'][2]['school']['name'], "Tempor Limited"
        );
        $this->assertEquals(
            $datas['result']['list'][2]['school']['short_name'], "ornare"
        );
        $this->assertEquals(
            $datas['result']['list'][2]['school']['logo'], null
        );
        $this->assertEquals($datas['result']['list'][2]['id'], 77);
        $this->assertEquals(
            $datas['result']['list'][2]['firstname'], "Malcolm"
        );
        $this->assertEquals($datas['result']['list'][2]['lastname'], "Becker");
        $this->assertEquals(
            $datas['result']['list'][2]['email'], "placerat.Cras.dictum@libero.com"
        );
        $this->assertEquals(
            $datas['result']['list'][2]['password'], "4ac91ac4cb1614b368e3dff3ac718f1d"
        );
        $this->assertEquals(
            !empty($datas['result']['list'][2]['birth_date']), true
        );
        $this->assertEquals(
            $datas['result']['list'][2]['position'], "metus sit amet"
        );
        $this->assertEquals(
            $datas['result']['list'][2]['interest'], "convallis convallis dolor. Quisque tincidunt"
        );
        $this->assertEquals($datas['result']['list'][2]['avatar'], null);
        $this->assertEquals(count($datas['result']['list'][2]['roles']), 1);
        $this->assertEquals(
            $datas['result']['list'][2]['roles'][0], "academic"
        );
        $this->assertEquals(count($datas['result']['list'][2]['program']), 1);
        $this->assertEquals(
            count($datas['result']['list'][2]['program'][0]), 5
        );
        $this->assertEquals(
            $datas['result']['list'][2]['program'][0]['id'], 46
        );
        $this->assertEquals(
            $datas['result']['list'][2]['program'][0]['name'], "ornare, lectus ante dictum"
        );
        $this->assertEquals(
            $datas['result']['list'][2]['program'][0]['level'], "emba"
        );
        $this->assertEquals(
            $datas['result']['list'][2]['program'][0]['sis'], "B8E"
        );
        $this->assertEquals(
            $datas['result']['list'][2]['program'][0]['year'], null
        );
    }
    ...
    public function testCanAddUserCourse($course)
    {
        ...
        $datas = $this->jsonRpc(
            'user.addCourse', array('user' => 1, 'course' => $course)
        );
    ...
    public function testCanGetCoursesListByUser($program)
    {
        ...
        $this->assertEquals(
            $datas['result']['list'][0]['abstract'], "un_token"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['description'], "description"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['objectives'], "objectives"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['teaching'], "teaching"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['attendance'], "attendance"
        );
        $this->assertEquals($datas['result']['list'][0]['duration'], 18);
        $this->assertEquals($datas['result']['list'][0]['notes'], "notes");
        $this->assertEquals(
            $datas['result']['list'][0]['learning_outcomes'], "learning_outcomes"
        );
        $this->assertEquals($datas['result']['list'][0]['picture'], null);
        $this->assertEquals(
            $datas['result']['list'][0]['video_link'], "http://google.fr"
        );
        $this->assertEquals(
            $datas['result']['list'][0]['video_token'], "video_token"
        );
        $this->assertEquals($datas['id'], 1);
        $this->assertEquals($datas['jsonrpc'], 2.0);
    ...
    public function testCanAddDeleteCourse($course)
    {
        ...
        $datas = $this->jsonRpc(
            'user.deleteCourse', array('user' => 1, 'course' => $course)
        );
    ...
    public function testGetThread($course)
    {
        ...
        $this->assertEquals(
            $datas['result'][0]['user']['firstname'], "Nicolas"
        );
        $this->assertEquals(
            $datas['result'][0]['user']['lastname'], "Maremmani"
        );
        $this->assertEquals($datas['result'][0]['id'], 1);
    ...
    public function testGetListThreadMessage($thread)
    {
        ...
        $this->assertEquals(
            $datas['result'][0]['user']['firstname'], "Xuan-Anh"
        );
        $this->assertEquals($datas['result'][0]['user']['lastname'], "Hoang");
        $this->assertEquals($datas['result'][0]['id'], 1);
        $this->assertEquals(
            $datas['result'][0]['message'], "un super message update"
        );
        $this->assertEquals(!empty($datas['result'][0]['created_date']), true);
        $this->assertEquals($datas['id'], 1);
        $this->assertEquals($datas['jsonrpc'], 2.0);
     ...
     */
    public
    function testCourseGetList($program
    ) {
        $this->setIdentity(1);
    ...
    {
        $identityMock = $this->getMockBuilder(
            '\Auth\Authentication\Adapter\Model\Identity'
        )
