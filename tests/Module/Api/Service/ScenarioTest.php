...
class ScenarioTest extends AbstractService
{
    ...
    public function testCanAddSchool()
    {
        ...
        $this->assertEquals($data['result']['address']['country']['short_name'] , "");
        ...
        $this->assertEquals($data['result']['address']['longitude'] , 7.3999877);
        $this->assertEquals($data['result']['address']['latitude'] , 43.7441144);
    ...
    public function testAddCourse($school_id, $program_id)
    {
        ...
        $this->assertEquals(count($data['result']['material_document'][0]) , 13);
        $this->assertEquals($data['result']['material_document'][0]['id'] , 1);
        $this->assertEquals($data['result']['material_document'][0]['description'] , null);
    ...
    public function testCanGetListItem($course)
    {
        ...
        $this->assertEquals($data['result'][1]['duration'] , 234);
        ...
        $this->assertEquals($data['result'][1]['module_id'] , null);
        $this->assertEquals($data['id'] , 1);
        $this->assertEquals($data['jsonrpc'] , 2.0);
    }
    ...
    public function testGetCourse($id)
    {
        ...
        $this->assertEquals($data['result']['material_document'][0]['deleted_date'] , null);
        $this->assertEquals($data['result']['material_document'][0]['updated_date'] , null);
        $this->assertEquals(count($data['result']['material_document'][1]) , 13);
        $this->assertEquals($data['result']['material_document'][1]['id'] , 2);
        $this->assertEquals($data['result']['material_document'][1]['description'] , null);
        ...
        $this->assertEquals(count($data['result']['material_document'][2]) , 13);
        $this->assertEquals($data['result']['material_document'][2]['id'] , 3);
        $this->assertEquals($data['result']['material_document'][2]['description'] , null);
    ...
    public function testCanGetItemsProgUSerByModule($module)
    {
        ...
        $this->assertEquals(count($data['result'][0]['item_prog'][0]['item_prog_user']), 5);
        $this->assertEquals($data['result'][0]['item_prog'][0]['item_prog_user']['id'], 3);
        $this->assertEquals($data['result'][0]['item_prog'][0]['item_prog_user']['user_id'], 4);
        $this->assertEquals($data['result'][0]['item_prog'][0]['item_prog_user']['item_prog_id'], 1);
        $this->assertEquals(! empty($data['result'][0]['item_prog'][0]['item_prog_user']['started_date']), true);
        $this->assertEquals(! empty($data['result'][0]['item_prog'][0]['item_prog_user']['finished_date']), true);
        $this->assertEquals(count($data['result'][0]['item_prog'][0]['users']), 2);
        $this->assertEquals(count($data['result'][0]['item_prog'][0]['users'][0]), 5);
        $this->assertEquals(count($data['result'][0]['item_prog'][0]['users'][0]['item_prog_user']), 2);
        $this->assertEquals(! empty($data['result'][0]['item_prog'][0]['users'][0]['item_prog_user']['started_date']), true);
        $this->assertEquals(! empty($data['result'][0]['item_prog'][0]['users'][0]['item_prog_user']['finished_date']), true);
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][0]['id'], 4);
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][0]['firstname'], "Salim");
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][0]['lastname'], "Bendacha");
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][0]['avatar'], null);
        $this->assertEquals(count($data['result'][0]['item_prog'][0]['users'][1]), 5);
        $this->assertEquals(count($data['result'][0]['item_prog'][0]['users'][1]['item_prog_user']), 2);
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][1]['item_prog_user']['started_date'], null);
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][1]['item_prog_user']['finished_date'], null);
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][1]['id'], 6);
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][1]['firstname'], "Guillaume");
        $this->assertEquals($data['result'][0]['item_prog'][0]['users'][1]['lastname'], "Masmejean");
    ...
    public function testCanGetListDetail()
    {
        ...
        $this->assertEquals(count($data['result'][0]['item_prog'][0]['item']), 7);
    ...
    public function testEventGetList()
    {
       ...
       $this->assertEquals(count($data['result']['list'][0]['source']['data']) , 7);
       ...
       $this->assertEquals(count($data['result']['list'][1]['source']['data']) , 7);
       ...
       $this->assertEquals(count($data['result']['list'][2]['source']['data']) , 7);
       ...
       $this->assertEquals($data['result']['list'][3]['id'] , 11);
       $this->assertEquals(count($data['result']['list'][3]['source']) , 3);
       $this->assertEquals($data['result']['list'][3]['source']['id'] , 3);
       $this->assertEquals($data['result']['list'][3]['source']['name'] , "user");
       $this->assertEquals(count($data['result']['list'][3]['source']['data']) , 7);
       $this->assertEquals($data['result']['list'][3]['source']['data']['firstname'] , "Christophe");
       $this->assertEquals($data['result']['list'][3]['source']['data']['email'] , "crobert@thestudnet.com");
       $this->assertEquals($data['result']['list'][3]['source']['data']['lastname'] , "Robert");
       ...
       $this->assertEquals($data['result']['list'][3]['source']['data']['school']['id'] , 1);
       $this->assertEquals($data['result']['list'][3]['source']['data']['school']['name'] , "Morbi Corporation");
       $this->assertEquals($data['result']['list'][3]['source']['data']['school']['short_name'] , "turpis");
       $this->assertEquals($data['result']['list'][3]['source']['data']['school']['logo'] , null);
       $this->assertEquals($data['result']['list'][3]['source']['data']['school']['background'] , null);
       $this->assertEquals(count($data['result']['list'][3]['source']['data']['user_roles']) , 1);
       $this->assertEquals($data['result']['list'][3]['source']['data']['user_roles'][0] , "academic");
       $this->assertEquals(!empty($data['result']['list'][3]['date']) , true);
       $this->assertEquals($data['result']['list'][3]['event'] , "task.shared");
       $this->assertEquals(count($data['result']['list'][3]['object']) , 3);
       $this->assertEquals($data['result']['list'][3]['object']['id'] , 1);
       $this->assertEquals($data['result']['list'][3]['object']['name'] , "task");
       $this->assertEquals(count($data['result']['list'][3]['object']['data']) , 6);
       $this->assertEquals($data['result']['list'][3]['object']['data']['id'] , 1);
       $this->assertEquals($data['result']['list'][3]['object']['data']['title'] , "TEST");
       $this->assertEquals($data['result']['list'][3]['object']['data']['content'] , null);
       $this->assertEquals(!empty($data['result']['list'][3]['object']['data']['start']) , true);
       $this->assertEquals(!empty($data['result']['list'][3]['object']['data']['end']) , true);
       $this->assertEquals($data['result']['list'][3]['object']['data']['creator_id'] , 3);
       ...
       $this->assertEquals($data['result']['list'][4]['id'] , 6);
       $this->assertEquals(count($data['result']['list'][4]['source']) , 3);
       $this->assertEquals($data['result']['list'][4]['source']['id'] , 3);
       $this->assertEquals($data['result']['list'][4]['source']['name'] , "user");
       $this->assertEquals(count($data['result']['list'][4]['source']['data']) , 7);
       $this->assertEquals($data['result']['list'][4]['source']['data']['firstname'] , "Christophe");
       $this->assertEquals($data['result']['list'][4]['source']['data']['email'] , "crobert@thestudnet.com");
       $this->assertEquals($data['result']['list'][4]['source']['data']['lastname'] , "Robert");
       ...
       $this->assertEquals($data['result']['list'][4]['source']['data']['school']['id'] , 1);
       $this->assertEquals($data['result']['list'][4]['source']['data']['school']['name'] , "Morbi Corporation");
       $this->assertEquals($data['result']['list'][4]['source']['data']['school']['short_name'] , "turpis");
       $this->assertEquals($data['result']['list'][4]['source']['data']['school']['logo'] , null);
       $this->assertEquals($data['result']['list'][4]['source']['data']['school']['background'] , null);
       $this->assertEquals(count($data['result']['list'][4]['source']['data']['user_roles']) , 1);
       $this->assertEquals($data['result']['list'][4]['source']['data']['user_roles'][0] , "academic");
       $this->assertEquals(!empty($data['result']['list'][4]['date']) , true);
       $this->assertEquals($data['result']['list'][4]['event'] , "course.material_added");
       ...
       $this->assertEquals(count($data['result']['list'][4]['object']['data']['material']) , 6);
       $this->assertEquals($data['result']['list'][4]['object']['data']['material']['type'] , "type2");
       $this->assertEquals($data['result']['list'][4]['object']['data']['material']['title'] , "title2");
       $this->assertEquals($data['result']['list'][4]['object']['data']['material']['author'] , "author2");
       $this->assertEquals($data['result']['list'][4]['object']['data']['material']['link'] , "link2");
       $this->assertEquals($data['result']['list'][4]['object']['data']['material']['source'] , "src2");
       $this->assertEquals($data['result']['list'][4]['object']['data']['material']['token'] , "token2");
       ...
       $this->assertEquals($data['result']['list'][5]['id'] , 5);
       $this->assertEquals(count($data['result']['list'][5]['source']) , 3);
       $this->assertEquals($data['result']['list'][5]['source']['id'] , 3);
       $this->assertEquals($data['result']['list'][5]['source']['name'] , "user");
       $this->assertEquals(count($data['result']['list'][5]['source']['data']) , 7);
       $this->assertEquals($data['result']['list'][5]['source']['data']['firstname'] , "Christophe");
       $this->assertEquals($data['result']['list'][5]['source']['data']['email'] , "crobert@thestudnet.com");
       $this->assertEquals($data['result']['list'][5]['source']['data']['lastname'] , "Robert");
       $this->assertEquals($data['result']['list'][5]['source']['data']['has_email_notifier'] , 1);
       $this->assertEquals($data['result']['list'][5]['source']['data']['avatar'] , null);
       $this->assertEquals(count($data['result']['list'][5]['source']['data']['school']) , 5);
       $this->assertEquals($data['result']['list'][5]['source']['data']['school']['id'] , 1);
       $this->assertEquals($data['result']['list'][5]['source']['data']['school']['name'] , "Morbi Corporation");
       $this->assertEquals($data['result']['list'][5]['source']['data']['school']['short_name'] , "turpis");
       $this->assertEquals($data['result']['list'][5]['source']['data']['school']['logo'] , null);
       $this->assertEquals($data['result']['list'][5]['source']['data']['school']['background'] , null);
       ...
       $this->assertEquals($data['result']['list'][5]['event'] , "course.material_added");
       $this->assertEquals(count($data['result']['list'][5]['object']) , 3);
       $this->assertEquals($data['result']['list'][5]['object']['id'] , 1);
       $this->assertEquals($data['result']['list'][5]['object']['name'] , "course");
       $this->assertEquals(count($data['result']['list'][5]['object']['data']) , 3);
       $this->assertEquals($data['result']['list'][5]['object']['data']['title'] , "IMERIR");
       $this->assertEquals(count($data['result']['list'][5]['object']['data']['picture']) , 0);
       $this->assertEquals(count($data['result']['list'][5]['object']['data']['material']) , 6);
       $this->assertEquals($data['result']['list'][5]['object']['data']['material']['type'] , "type");
       $this->assertEquals($data['result']['list'][5]['object']['data']['material']['title'] , "title");
       $this->assertEquals($data['result']['list'][5]['object']['data']['material']['author'] , "author");
       $this->assertEquals($data['result']['list'][5]['object']['data']['material']['link'] , "link");
       $this->assertEquals($data['result']['list'][5]['object']['data']['material']['source'] , "src");
       $this->assertEquals($data['result']['list'][5]['object']['data']['material']['token'] , "token");
       ...
       $this->assertEquals($data['result']['list'][6]['id'] , 4);
       $this->assertEquals(count($data['result']['list'][6]['source']) , 3);
       $this->assertEquals($data['result']['list'][6]['source']['id'] , 1);
       $this->assertEquals($data['result']['list'][6]['source']['name'] , "user");
       $this->assertEquals(count($data['result']['list'][6]['source']['data']) , 7);
       $this->assertEquals($data['result']['list'][6]['source']['data']['firstname'] , "Paul");
       $this->assertEquals($data['result']['list'][6]['source']['data']['email'] , "pboussekey@thestudnet.com");
       $this->assertEquals($data['result']['list'][6]['source']['data']['lastname'] , "Boussekey");
       $this->assertEquals($data['result']['list'][6]['source']['data']['has_email_notifier'] , 1);
       $this->assertEquals($data['result']['list'][6]['source']['data']['avatar'] , null);
       $this->assertEquals(count($data['result']['list'][6]['source']['data']['school']) , 5);
       $this->assertEquals($data['result']['list'][6]['source']['data']['school']['id'] , 2);
       $this->assertEquals($data['result']['list'][6]['source']['data']['school']['name'] , "université de monaco");
       $this->assertEquals($data['result']['list'][6]['source']['data']['school']['short_name'] , "IUM");
       $this->assertEquals($data['result']['list'][6]['source']['data']['school']['logo'] , "token");
       $this->assertEquals($data['result']['list'][6]['source']['data']['school']['background'] , "background");
       $this->assertEquals(count($data['result']['list'][6]['source']['data']['user_roles']) , 1);
       $this->assertEquals($data['result']['list'][6]['source']['data']['user_roles'][0] , "admin");
       $this->assertEquals(!empty($data['result']['list'][6]['date']) , true);
       $this->assertEquals($data['result']['list'][6]['event'] , "course.updated");
       $this->assertEquals(count($data['result']['list'][6]['object']) , 3);
       $this->assertEquals($data['result']['list'][6]['object']['id'] , 1);
       $this->assertEquals($data['result']['list'][6]['object']['name'] , "course");
       $this->assertEquals(count($data['result']['list'][6]['object']['data']) , 4);
       $this->assertEquals($data['result']['list'][6]['object']['data']['title'] , "IMERIR");
       $this->assertEquals(count($data['result']['list'][6]['object']['data']['picture']) , 0);
       $this->assertEquals($data['result']['list'][6]['object']['data']['program'] , 1);
       $this->assertEquals(count($data['result']['list'][6]['object']['data']['updated']) , 11);
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][0] , "title");
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][1] , "abstract");
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][2] , "description");
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][3] , "objectives");
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][4] , "teaching");
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][5] , "attendance");
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][6] , "duration");
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][7] , "notes");
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][8] , "learning_outcomes");
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][9] , "video_link");
       $this->assertEquals($data['result']['list'][6]['object']['data']['updated'][10] , "video_token");
       $this->assertEquals(count($data['result']['list'][6]['comment']) , 0);
       $this->assertEquals(count($data['result']['list'][7]) , 10);
       $this->assertEquals($data['result']['list'][7]['view_date'] , null);
       $this->assertEquals($data['result']['list'][7]['is_like'] , 0);
       $this->assertEquals($data['result']['list'][7]['nb_like'] , 0);
       $this->assertEquals($data['result']['list'][7]['read_date'] , null);
       $this->assertEquals($data['result']['list'][7]['id'] , 2);
       $this->assertEquals(count($data['result']['list'][7]['source']) , 3);
       $this->assertEquals($data['result']['list'][7]['source']['id'] , 1);
       $this->assertEquals($data['result']['list'][7]['source']['name'] , "user");
       $this->assertEquals(count($data['result']['list'][7]['source']['data']) , 7);
       $this->assertEquals($data['result']['list'][7]['source']['data']['firstname'] , "Paul");
       $this->assertEquals($data['result']['list'][7]['source']['data']['email'] , "pboussekey@thestudnet.com");
       $this->assertEquals($data['result']['list'][7]['source']['data']['lastname'] , "Boussekey");
       $this->assertEquals($data['result']['list'][7]['source']['data']['has_email_notifier'] , 1);
       $this->assertEquals($data['result']['list'][7]['source']['data']['avatar'] , null);
       $this->assertEquals(count($data['result']['list'][7]['source']['data']['school']) , 5);
       $this->assertEquals($data['result']['list'][7]['source']['data']['school']['id'] , 2);
       $this->assertEquals($data['result']['list'][7]['source']['data']['school']['name'] , "université de monaco");
       $this->assertEquals($data['result']['list'][7]['source']['data']['school']['short_name'] , "IUM");
       $this->assertEquals($data['result']['list'][7]['source']['data']['school']['logo'] , "token");
       $this->assertEquals($data['result']['list'][7]['source']['data']['school']['background'] , "background");
       $this->assertEquals(count($data['result']['list'][7]['source']['data']['user_roles']) , 1);
       $this->assertEquals($data['result']['list'][7]['source']['data']['user_roles'][0] , "admin");
       $this->assertEquals(!empty($data['result']['list'][7]['date']) , true);
       $this->assertEquals($data['result']['list'][7]['event'] , "profile.updated");
       $this->assertEquals(count($data['result']['list'][7]['object']) , 3);
       ...
       $this->assertEquals($data['result']['list'][8]['is_like'] , 0);
       $this->assertEquals($data['result']['list'][8]['nb_like'] , 0);
       $this->assertEquals($data['result']['list'][8]['read_date'] , null);
       $this->assertEquals($data['result']['list'][8]['id'] , 1);
       $this->assertEquals(count($data['result']['list'][8]['source']) , 0);
       $this->assertEquals(!empty($data['result']['list'][8]['date']) , true);
       $this->assertEquals($data['result']['list'][8]['event'] , "school.new");
       $this->assertEquals(count($data['result']['list'][8]['object']) , 3);
       $this->assertEquals($data['result']['list'][8]['object']['id'] , 2);
       $this->assertEquals($data['result']['list'][8]['object']['name'] , "school");
       $this->assertEquals(count($data['result']['list'][8]['object']['data']) , 4);
       $this->assertEquals($data['result']['list'][8]['object']['data']['id'] , 2);
       $this->assertEquals($data['result']['list'][8]['object']['data']['name'] , "université de monaco");
       $this->assertEquals($data['result']['list'][8]['object']['data']['short_name'] , "IUM");
       $this->assertEquals($data['result']['list'][8]['object']['data']['logo'] , "token");
       $this->assertEquals(count($data['result']['list'][8]['comment']) , 0);
