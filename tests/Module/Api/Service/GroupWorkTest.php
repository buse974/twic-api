...
class GroupWorkTest extends AbstractService
{
    ...
    public function testCanGetListSubmission($item_id)
    {
        ...
        $this->assertEquals(count($data['result'][0]['submission_user'][2]) , 1);
        $this->assertEquals(count($data['result'][0]['submission_user'][2]['user']) , 11);
        ...
        $this->assertEquals(count($data['result'][1]['submission_user'][0]) , 1);
        $this->assertEquals(count($data['result'][1]['submission_user'][0]['user']) , 11);
        $this->assertEquals($data['result'][1]['submission_user'][0]['user']['gender'] , null);
        $this->assertEquals($data['result'][1]['submission_user'][0]['user']['id'] , 2);
        $this->assertEquals($data['result'][1]['submission_user'][0]['user']['firstname'] , "Xuan-Anh");
        $this->assertEquals($data['result'][1]['submission_user'][0]['user']['lastname'] , "Hoang");
        $this->assertEquals($data['result'][1]['submission_user'][0]['user']['email'] , "xhoang@thestudnet.com");
        ...
        $this->assertEquals(count($data['result'][1]['submission_user'][1]) , 1);
        $this->assertEquals(count($data['result'][1]['submission_user'][1]['user']) , 11);
        $this->assertEquals($data['result'][1]['submission_user'][1]['user']['gender'] , null);
        $this->assertEquals($data['result'][1]['submission_user'][1]['user']['id'] , 5);
        $this->assertEquals($data['result'][1]['submission_user'][1]['user']['firstname'] , "Sébastien");
        $this->assertEquals($data['result'][1]['submission_user'][1]['user']['lastname'] , "Sayegh");
        $this->assertEquals($data['result'][1]['submission_user'][1]['user']['email'] , "ssayegh@thestudnet.com");
        ...
        $this->assertEquals($data['result'][1]['id'] , null);
        $this->assertEquals($data['result'][1]['group_id'] , 2);
        $this->assertEquals($data['result'][1]['group_name'] , "namegroup2");
        ...
        $this->assertEquals(count($data['result'][2]['submission_user'][0]) , 1);
        $this->assertEquals(count($data['result'][2]['submission_user'][0]['user']) , 11);
        ...
        $this->assertEquals(count($data['result'][2]['submission_user'][1]) , 1);
        $this->assertEquals(count($data['result'][2]['submission_user'][1]['user']) , 11);
        ...
        $this->assertEquals($data['result'][2]['id'] , null);
        $this->assertEquals($data['result'][2]['group_id'] , 3);
        $this->assertEquals($data['result'][2]['group_name'] , "namegroup3");
