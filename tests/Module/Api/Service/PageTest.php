...
class PageTest extends AbstractService
{
    ...
    public function testPageGet($page_id)
    {
        ...
        $this->assertEquals($data['result']['users']['list'][0]['page_id'] , 1);
        $this->assertEquals($data['result']['users']['list'][0]['user_id'] , 1);
        $this->assertEquals($data['result']['users']['list'][0]['role'] , "admin");
        $this->assertEquals($data['result']['users']['list'][0]['state'] , "member");
        $this->assertEquals(count($data['result']['users']['list'][1]) , 4);
        $this->assertEquals($data['result']['users']['list'][1]['page_id'] , 1);
        $this->assertEquals($data['result']['users']['list'][1]['user_id'] , 2);
        $this->assertEquals($data['result']['users']['list'][1]['role'] , "admin");
        $this->assertEquals($data['result']['users']['list'][1]['state'] , "member");
        $this->assertEquals(count($data['result']['users']['list'][2]) , 4);
        $this->assertEquals($data['result']['users']['list'][2]['page_id'] , 1);
        $this->assertEquals($data['result']['users']['list'][2]['user_id'] , 3);
        $this->assertEquals($data['result']['users']['list'][2]['role'] , "admin");
        $this->assertEquals($data['result']['users']['list'][2]['state'] , "member");
        $this->assertEquals($data['result']['users']['count'] , 3);
