...
class FeedTest extends AbstractService
{
    ...
    public function testgetList()
    {
        ...
        $this->assertEquals($data['result'][1]['content'], "UN FEED2");
        $this->assertEquals($data['result'][1]['user_id'], 2);
        $this->assertEquals($data['result'][1]['link'], "link2");
        $this->assertEquals($data['result'][1]['video'], "token2");
        $this->assertEquals($data['result'][1]['picture'], "tokenp2");
        $this->assertEquals($data['result'][1]['document'], "tokend2");
    ...
    public function testgetListComment($feed)
    {
        ...
        $this->assertEquals($data['result'][0]['feed_id'] , 2);
        $this->assertEquals(!empty($data['result'][0]['created_date']) , true);
        $this->assertEquals($data['result'][0]['deleted_date'] , null);
        $this->assertEquals($data['id'] , 1);
        $this->assertEquals($data['jsonrpc'] , 2.0);
