...
class PollTest extends AbstractService
{
    ...
    public function testCanGetSubmissionContent($submission_id)
    {
        ...
        $this->assertEquals($data['result']['poll'][0]['bank_questions'][1]['older'] , 1);
        ...
        $this->assertEquals($data['result']['poll'][0]['bq_items'][4]['bank_answer_item']['bank_question_item_id'] , 9);
        $this->assertEquals($data['result']['poll'][0]['bq_items'][4]['bank_answer_item']['percent'] , 99);
        ...
        $this->assertEquals($data['result']['poll'][0]['bq_items'][4]['id'] , 9);
        $this->assertEquals($data['result']['poll'][0]['bq_items'][4]['libelle'] , "non");
        ...
        $this->assertEquals($data['result']['poll'][0]['bq_items'][5]['bank_answer_item']['bank_question_item_id'] , 10);
        ...
        $this->assertEquals($data['result']['poll'][0]['bq_items'][5]['id'] , 10);
        $this->assertEquals($data['result']['poll'][0]['bq_items'][5]['libelle'] , "peu etre");
        ...
        $this->assertEquals($data['result']['poll'][0]['medias'][0]['library']['id'] , 4);
        ...
        $this->assertEquals($data['result']['poll'][0]['medias'][0]['library']['token'] , "token2");
        ...
        $this->assertEquals($data['result']['poll'][0]['medias'][1]['library']['id'] , 5);
